...
<\body>
  ...
  has a solution in <math|\<bbb-C\>>. In other words there exist a
  <math|z<rsub|0>\<in\>\<bbb-C\>> such that\ 

  <\equation*>
    a<rsub|n>\<cdot\>z<rsub|0><rsup|<phantom|0>n>+a<rsub|n-1>\<cdot\>z<rsub|0><rsup|<phantom|0>n-1>+\<cdots\>+a<rsub|0>=0
  </equation*>

  In many books this is done by integration in the complex plane. However in
  this book we will use algebraic and analytic operations to prove the
  theorem. First to define the concept of a higher order equation we
  introduce the concept of polynomials.
  ...
  The following is a very trivial lemma that shows how to construct new
  polynomials from another polynomial.

  <\lemma>
    <label|lemma 17.10.155>Let <math|p\<in\>\<cal-P\>> a polynomial and
    <math|c\<in\>\<bbb-C\>\\<around*|{|0|}>> then
    <math|c\<cdot\>p:\<bbb-C\>\<rightarrow\>\<bbb-C\><text| defined by
    ><around*|(|c\<cdot\>p|)><around*|(|x|)>=c\<cdot\>p<around*|(|z|)>> is a
    polynomial with <math|ord<around*|(|c\<cdot\>p|)>=ord<around*|(|p|)>>.
  </lemma>

  <\proof>
    As <math|p> is a polynomial there exist a family
    <math|<around*|{|a<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    with <math|a<rsub|n>\<neq\>0> where <math|n=ord<around*|(|p|)>>. Define
    <math|<around*|{|b<rsub|i>|}><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>\<subseteq\>\<bbb-C\>>
    by <math|b<rsub|i>=c\<cdot\>a<rsub|i>> then as
    <math|c\<neq\>0\<wedge\>a<rsub|n>\<neq\>0> we have that
    <math|b<rsub|n>\<neq\>0> so that\ 

    <\equation*>
      q:\<bbb-C\>\<rightarrow\>\<bbb-C\><text| defined by
      >q<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>b<rsub|i>\<cdot\>z<rsup|i>
    </equation*>

    is a polynomial with <math|ord<around*|(|q|)>=n>. As
    <math|\<forall\>z\<in\>\<bbb-C\>> we have\ 

    <\equation*>
      q<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>b<rsub|i>\<cdot\>z<rsup|i>=<big|sum><rsub|i=0><rsup|n>c\<cdot\>a<rsub|i>\<cdot\>z<rsup|i>=c\<cdot\><big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>=c\<cdot\>p<around*|(|z|)>=<around*|(|c\<cdot\>p|)><around*|(|z|)>
    </equation*>

    it follows that <math|q=c\<cdot\>p> so that <math|c\<cdot\>p> is a
    polynomial with <math|ord<around*|(|c\<cdot\>p|)>=n=ord<around*|(|p|)>>.
  </proof>
  ...
  <\proof>
    ...
    that <math|i=r+s=j> contradicting <math|i\<neq\>j> so that\ 
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|\<zeta\><rsup|k>>|<cell|=>|<cell|>>|<row|<cell|<around*|(|<around*|(|1+<frac|i|k>|)><rsup|2>|)><rsup|k>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|complex (x^n)^m>]>>>|<cell|>>|<row|<cell|<around*|(|1+<frac|i|k>|)><rsup|2\<cdot\>k>>|<cell|\<equallim\><rsub|k=2\<cdot\>n>>|<cell|>>|<row|<cell|<around*|(|1+<frac|i|2\<cdot\>n>|)><rsup|4\<cdot\>n>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|fundamental binomial formula>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l=0><rsup|4\<cdot\>n><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>\<cdot\>1<rsup|4\<cdot\>n-l>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l=0><rsup|4\<cdot\>n><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,2\<cdot\><around*|(|2\<cdot\>n|)>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>>|<cell|\<equallim\><rsub|<text|[lemma:
      <reference|lemma 17.26.136>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n|}>|}><big|sqcup><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n-1|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>+<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n-1|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>>|<cell|>|<cell|>>>>
    </eqnarray*>

    so that we have\ 

    <\equation>
      <label|eq 17.21.154>\<zeta\><rsup|k>=A+B
    </equation>

    where\ 

    <\equation>
      <label|eq 17.22.154>A=<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>
    </equation>

    <\equation>
      <label|eq 17.23.154>B=<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n-1|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>
    </equation>
    ...
    <\eqnarray*>
      ...
      <reference|eq 17.22.154>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,2\<cdot\>n|}>|}>><binom|4\<cdot\>n|l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|l>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|sum bijection on index>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,2\<cdot\>n|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>>|<cell|\<equallim\><rsub|<text|[lemma:
      <reference|lemma 17.26.136>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,n|}>|}><big|sqcup><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,n-1|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,n|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>+<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,n-1|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>>|<cell|>|<cell|>>>>
    </eqnarray*>

    So that\ 

    <\equation>
      <label|eq 17.24.154>A=C+D
    </equation>

    where\ 

    <\equation>
      <label|eq 17.25.154>C=<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,n|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>
    </equation>

    <\equation>
      <label|eq 17.26.154>D=<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,n-1|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>
    </equation>

    For <math|C> we have\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|C>|<cell|\<equallim\><rsub|<text|[eq:
      <reference|eq 17.25.154>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j\|j\<in\><around*|{|0,\<ldots\>,n|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|sum bijection on index>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n|}>><binom|4\<cdot\>n|2\<cdot\><around*|(|2\<cdot\>l|)>>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\><around*|(|2\<cdot\>l|)>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n|}>><binom|4\<cdot\>n|4\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|4\<cdot\>l>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n|}>><binom|4\<cdot\>n|4\<cdot\>l>\<cdot\><frac|i<rsup|4\<cdot\>l>|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l>>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|complex power of i>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n|}>><binom|4\<cdot\>n|4\<cdot\>l>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l>>>|<cell|=>|<cell|>>|<row|<cell|<binom|4\<cdot\>n|4\<cdot\>0>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>0>>+<binom|4\<cdot\>n|4\<cdot\>1>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>1>>+<big|sum><rsub|l\<in\><around*|{|2,\<ldots\>,n|}>><binom|4\<cdot\>n|4\<cdot\>l>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l>>>|<cell|=>|<cell|>>|<row|<cell|1+<binom|4\<cdot\>n|4>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4>>+<big|sum><rsub|l\<in\><around*|{|2,\<ldots\>,n|}>><binom|4\<cdot\>n|4\<cdot\>l>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l>>>|<cell|=>|<cell|>>|<row|<cell|1+<binom|4\<cdot\>n|4>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4>>+<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>>|<cell|\<equallim\><rsub|2\<cdot\>n=k>>|<cell|>>|<row|<cell|1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>+<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>>|<cell|>|<cell|>>>>
    </eqnarray*>

    so that\ 

    <\equation>
      <label|eq 17.27.154>C=1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>+<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>
    </equation>

    For <math|D> we have

    <\eqnarray*>
      <tformat|<table|<row|<cell|D>|<cell|\<equallim\><rsub|<text|[eq:
      <reference|eq 17.26.154>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|2\<cdot\>j+1\|j\<in\><around*|{|0,\<ldots\>,n-1|}>|}>><binom|4\<cdot\>n|2\<cdot\>l>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\>l>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|sum bijection on index>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n-1|}>><binom|4\<cdot\>n|2\<cdot\><around*|(|2\<cdot\>l+1|)>>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|2\<cdot\><around*|(|2\<cdot\>l+1|)>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><around*|(|<frac|i|2\<cdot\>n>|)><rsup|4\<cdot\>l+2>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|i<rsup|4\<cdot\>l+2>|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|\<equallim\><rsub|<text|[theorem:
      <reference|complex power of i>]>>>|<cell|>>|<row|<cell|-<big|sum><rsub|l\<in\><around*|{|0,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|-<binom|4\<cdot\>n|4\<cdot\>0+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>0+2>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|-<binom|4\<cdot\>n|2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|\<equallim\><rsub|k=2\<cdot\>n>>|<cell|>>|<row|<cell|-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|>|<cell|>>>>
    </eqnarray*>

    So that\ 

    <\equation>
      <label|eq 17.28.154>D=-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>
    </equation>

    So we have from [eqs: <reference|eq 17.27.154>, <reference|eq 17.28.154>]
    that\ 

    <\equation>
      <label|eq 17.29.154>A=C+D=1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>+E
    </equation>

    where\ 

    <\equation>
      <label|eq 17.30.154>E=<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>
    </equation>

    First we look the term <math|1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>>
    and calculate <math|<binom|2\<cdot\>k|4>> in terms of
    <math|<binom|2\<cdot\>k|2>>. First notice that
    <math|2\<leqslant\>2\<cdot\>n=k> so that
    <math|2\<less\>3\<less\>4\<leqslant\>2\<cdot\>k> and thus
    <math|0\<less\>2\<cdot\>k-3\<wedge\>0\<less\>2\<cdot\>k-2> which we use
    in the following calculation:\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<binom|2\<cdot\>k|4>>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|4!\<cdot\><around*|(|2\<cdot\>k-4|)>!>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!|4\<cdot\>3\<cdot\>2!\<cdot\><around*|(|2\<cdot\>k-4|)>!>>>|<row|<cell|>|<cell|\<equallim\><rsub|0\<less\>2\<cdot\>k-3,2\<cdot\>k-2>>|<cell|<frac|<around*|(|2\<cdot\>k|)>!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>|4\<cdot\>3\<cdot\>2!\<cdot\><around*|(|2\<cdot\>k-4|)>!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>|4\<cdot\>3\<cdot\>2!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>\<cdot\><around*|(|2\<cdot\>k-4|)>!>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>|4\<cdot\>3\<cdot\>2!\<cdot\><around*|(|2\<cdot\>k-2|)>!>>>|<row|<cell|>|<cell|=>|<cell|<frac|<around*|(|2\<cdot\>k|)>!\<cdot\><around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>|2!\<cdot\><around*|(|2\<cdot\>k-2|)>!\<cdot\>4\<cdot\>3>>>|<row|<cell|>|<cell|=>|<cell|<binom|2\<cdot\>k|2>\<cdot\><frac|<around*|(|2\<cdot\>k-2|)>\<cdot\><around*|(|2\<cdot\>k-3|)>|4\<cdot\>3>>>|<row|<cell|>|<cell|=>|<cell|<binom|2\<cdot\>k|2>\<cdot\><frac|4\<cdot\>k<rsup|2>-6\<cdot\>k-4\<cdot\>k+6|12>>>|<row|<cell|>|<cell|=>|<cell|<binom|2\<cdot\>k|2>\<cdot\><frac|4\<cdot\>k<rsup|2>-10\<cdot\>k+6|12>>>|<row|<cell|>|<cell|=>|<cell|<binom|2\<cdot\>k|2>\<cdot\><frac|2\<cdot\>k<rsup|2>-5\<cdot\>k+3|6>>>>>
    </eqnarray*>

    so that\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><frac|2\<cdot\>k<rsup|2>-5\<cdot\>k+3|6>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>>>|<row|<cell|>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><around*|(|<frac|2\<cdot\>k<rsup|2>-5\<cdot\>k+3|6>\<cdot\><frac|1|k<rsup|4>>-<frac|1|k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|<frac|2\<cdot\>k<rsup|2>-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>-1|)>>>|<row|<cell|>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|<frac|2\<cdot\>k<rsup|2>-5\<cdot\>k+3-6\<cdot\>k<rsup|2>|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|<frac|-4\<cdot\>k<rsup|2>-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|-<frac|2|3>+<frac|-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<frac|<around*|(|2\<cdot\>k|)>!|2!\<cdot\><around*|(|2\<cdot\>k-2|)>!>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|-<frac|2|3>+<frac|-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<frac|2\<cdot\>k\<cdot\><around*|(|2\<cdot\>k-1|)>\<cdot\><around*|(|2\<cdot\>k-2|)>!|2\<cdot\><around*|(|2\<cdot\>k-2|)>!>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|-<frac|2|3>+<frac|-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+k\<cdot\><around*|(|2\<cdot\>k-1|)>\<cdot\><frac|1|k<rsup|2>>\<cdot\><around*|(|-<frac|2|3>+<frac|-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1+<around*|(|2-<frac|1|k>|)>\<cdot\><around*|(|-<frac|2|3>+<frac|-5\<cdot\>k+3|6\<cdot\>k<rsup|2>>|)>>>|<row|<cell|>|<cell|=>|<cell|1-<frac|4|3>+<frac|-5\<cdot\>k+3|3\<cdot\>k<rsup|2>>+<frac|2|3\<cdot\>k>-<frac|5\<cdot\>k+3|6\<cdot\>k<rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|-<frac|1|3>+<frac|-10\<cdot\>k<rsup|2>+3\<cdot\>k+4\<cdot\>k<rsup|2>-5\<cdot\>k+3|6\<cdot\>k<rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|-<frac|1|3>+<frac|-6\<cdot\>k<rsup|2>-2\<cdot\>k+3|6\<cdot\>k<rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|-<frac|1|3>+<frac|-6\<cdot\>k<rsup|2>|6\<cdot\>k<rsup|3>>+<frac|-2\<cdot\>k+3|6\<cdot\>k<rsup|3>>>>|<row|<cell|>|<cell|=>|<cell|-<frac|1|3>-<frac|1|k>+<frac|-2\<cdot\>k+3|6\<cdot\>k<rsup|3>>>>>>
    </eqnarray*>

    So that\ 

    <\equation>
      <label|eq 17.31.154>1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>=-<frac|1|3>-<frac|1|k>+<frac|-2\<cdot\>k+3|6\<cdot\>k<rsup|3>>
    </equation>

    As <math|2\<leqslant\>2\<cdot\>n=k> we have
    <math|4\<leqslant\>2\<cdot\>k\<Rightarrow\>3\<less\>2\<cdot\>k> or
    <math|3-2\<cdot\>k\<less\>0>, hence using the above we have that\ 

    <\equation>
      <label|eq 17.32.154>1+<binom|2\<cdot\>k|4>\<cdot\><frac|1|k<rsup|4>>-<binom|2\<cdot\>k|2>\<cdot\><frac|1|k<rsup|2>>\<less\>0
    </equation>

    Next we calculate the value of the terms in <math|E>

    <\eqnarray*>
      <tformat|<table|<row|<cell|E>|<cell|\<equallim\><rsub|<text|[eq
      <reference|eq 17.30.154>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>-<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>><around*|(|<binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>-<binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>|)>>|<cell|=>|<cell|>>>>
    </eqnarray*>

    So we have that\ 

    <\equation>
      <label|eq 17.33.154>E=<big|sum><rsub|l\<in\><around*|{|1,\<ldots\>,n-1|}>>E<rsub|l><text|
      where >E<rsub|l>=<binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>-<binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>
    </equation>

    Now for <math|l\<in\><around*|{|1,\<ldots\>,n-1|}>> we have

    <\eqnarray*>
      <tformat|<table|<row|<cell|E<rsub|l>>|<cell|=>|<cell|>>|<row|<cell|<binom|4\<cdot\>n|4\<cdot\><around*|(|l+1|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\><around*|(|l+1|)>>>-<binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|<binom|4\<cdot\>n|4\<cdot\>l+4>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+4>>-<binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|<binom|4\<cdot\>n|4\<cdot\>l+4>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>-<binom|4\<cdot\>n|4\<cdot\>l+2>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>\<cdot\><around*|(|<binom|4\<cdot\>n|4\<cdot\>l+4>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<binom|4\<cdot\>n|4\<cdot\>l+2>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>!\<cdot\><around*|(|4\<cdot\>n-<around*|(|4\<cdot\>l+4|)>|)>!>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-<around*|(|4\<cdot\>l+2|)>|)>!>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-2|)>!>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-2|)>!>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>!>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|1|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><around*|(|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><around*|(|<frac|1|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>>\<cdot\><frac|1|<around*|(|2\<cdot\>n|)><rsup|2>>-<frac|1|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>>|)>>|<cell|=>|<cell|>>|<row|<cell|<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>>|<cell|>|<cell|>>>>
    </eqnarray*>

    Define\ 

    <\equation*>
      F=<frac|<around*|(|4\<cdot\>n|)>!|<around*|(|2\<cdot\>n|)><rsup|4\<cdot\>l+2>\<cdot\><around*|(|4\<cdot\>l+2|)>!\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-4|)>!>\<cdot\><frac|1|<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>
    </equation*>

    \ then, as <math|l\<leqslant\>n-1\<Rightarrow\>4\<cdot\>l\<leqslant\>4\<cdot\>n-4\<Rightarrow\>0\<leqslant\>4\<cdot\>n-4\<cdot\>l-4\<less\>4\<cdot\>n-4\<cdot\>l-3\<less\>4\<cdot\>n-4\<cdot\>l-2>,
    we have that

    <\equation>
      <label|eq 17.34.154>0\<less\>F<text| and
      >E<rsub|l>=F\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>
    </equation>

    Now as <math|l\<in\><around*|{|0,\<ldots\>,n-1|}>> we have that
    <math|0\<less\>l\<less\>n>, further we have
    <math|1\<leqslant\>n\<Rightarrow\>1\<leqslant\>n<rsup|2>\<Rightarrow\>-16\<cdot\>n<rsup|2>\<leqslant\>-16>

    <\equation*>
      l<rsup|2>\<less\>n<rsup|2>,<text| >l\<less\>n<text| and
      >-16\<cdot\>n<rsup|2>\<leqslant\>-16
    </equation*>

    which will be use in the following calculation

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-<wide*|16\<cdot\>n\<cdot\>l|\<wide-underbrace\>><rsub|1>-<wide*|12\<cdot\>n|\<wide-underbrace\>><rsub|2>-<wide*|16\<cdot\>n\<cdot\>l|\<wide-underbrace\>><rsub|1>+16\<cdot\>l<rsup|2>+<wide*|12\<cdot\>l|\<wide-underbrace\>><rsub|3>-<wide*|8\<cdot\>n|\<wide-underbrace\>><rsub|2>+<wide*|8\<cdot\>l|\<wide-underbrace\>><rsub|3>+6-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-<wide*|32\<cdot\>n\<cdot\>l|\<wide-underbrace\>><rsub|1>-<wide*|20\<cdot\>n|\<wide-underbrace\>><rsub|2>+16\<cdot\>l<rsup|2>+<wide*|20\<cdot\>l|\<wide-underbrace\>><rsub|3>+6-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\>4\<cdot\>n<rsup|2>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-4\<cdot\>n<rsup|2>\<cdot\><around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-4\<cdot\>n<rsup|2>\<cdot\><around*|(|16\<cdot\>l<rsup|2>+12\<cdot\>l+16\<cdot\>l+12|)>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-4\<cdot\>n<rsup|2>\<cdot\><around*|(|16\<cdot\>l<rsup|2>+28\<cdot\>l+12|)>>|<cell|=>|<cell|>>|<row|<cell|16\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l-48\<cdot\>n<rsup|2>>|<cell|=>|<cell|>>|<row|<cell|<wide*|16\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l-<wide*|48\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>>|<cell|=>|<cell|>>|<row|<cell|<wide*|-32\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|=>|<cell|>>|<row|<cell|-32\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>l<rsup|2>+20\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|\<less\><rsub|l<rsup|2>\<less\>n<rsup|2>>>|<cell|>>|<row|<cell|-32\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>n<rsup|2>+20\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|\<less\><rsub|l\<less\>n>>|<cell|>>|<row|<cell|-32\<cdot\>n<rsup|2>-32\<cdot\>n\<cdot\>l-20\<cdot\>n+16\<cdot\>n<rsup|2>+20\<cdot\>n+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|=>|<cell|>>|<row|<cell|<wide*|-32\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>-32\<cdot\>n\<cdot\>l-<wide*|20\<cdot\>n|\<wide-underbrace\>><rsub|2>+<wide*|16\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>+<wide*|20\<cdot\>n|\<wide-underbrace\>><rsub|2>+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|=>|<cell|>>|<row|<cell|<wide*|-16\<cdot\>n<rsup|2>|\<wide-underbrace\>><rsub|1>-32\<cdot\>n\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|\<less\><rsub|-16n<rsup|2>\<leftarrow\>16>>|<cell|>>|<row|<cell|-16-32\<cdot\>n\<cdot\>l+6-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|=>|<cell|>>|<row|<cell|-10-32\<cdot\>n\<cdot\>l-64\<cdot\>n<rsup|2>\<cdot\>l<rsup|2>-112\<cdot\>n<rsup|2>\<cdot\>l>|<cell|\<less\>>|<cell|>>|<row|<cell|0>|<cell|>|<cell|>>>>
    </eqnarray*>

    Which proves that <math|<around*|(|4\<cdot\>n-4\<cdot\>l-2|)>\<cdot\><around*|(|4\<cdot\>n-4\<cdot\>l-3|)>-<around*|(|4\<cdot\>l+4|)>\<cdot\><around*|(|4\<cdot\>l+3|)>\<cdot\><around*|(|2\<cdot\>n|)><rsup|2>\<less\>0>
    and after combining this with [eq: <reference|eq 17.34.154>] that
    <math|\<forall\>l\<in\><around*|{|1,\<ldots\>,n-1|}>>
    <math|E<rsub|l>\<less\>0> so that by [eq: <reference|eq 17.33.154>]\ 

    <\equation>
      <label|eq 17.35.154>E\<less\>0
    </equation>

    Combining then [eqs: <reference|eq 17.35.154>, <reference|eq 17.32.154>
    and <reference|eq 17.29.154> proves that\ 
    ...
    <\equation>
      <label|eq 17.39.155>l\<leqslant\>n-1\<Rightarrow\>0\<leqslant\>n-l-1\<Rightarrow\>0\<leqslant\>4\<cdot\>n-4\<cdot\>l-4\<less\>4\<cdot\>n-4\<cdot\>l-2\<less\>4\<cdot\>n-4\<cdot\>l-1
    </equation>
  ...
  After all this work we are now ready to proof the fundamental theorem of
  algebra.
  ...
  <\theorem>
    ...
    <math|p<around*|(|z<rsub|0>|)>=0>. In other words every non constant
  ...
  <\proof>
    ...
    <\eqnarray*>
      ...
      <reference|sum distributivity>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|0,\<ldots\>,|}><rsup|2>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k=l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|l\<less\>k|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|l\<less\>k|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+<big|sum><rsub|<around*|(|j,i|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>\<cdot\>z<rsup|i>\<cdot\><around*|(|<wide|z|\<wide-bar\>>|)><rsup|j>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<wide-bar\>>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>>a<rsub|i>\<cdot\><wide|a<rsub|i>|\<wide-bar\>>\<cdot\>z<rsup|i>\<cdot\><around*|(|<wide|z|\<wide-bar\>>|)><rsup|i>+<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>+a<rsub|j>\<cdot\>z<rsup|j>\<cdot\><wide|a<rsub|i>\<cdot\>z<rsup|i>|\<wide-bar\>>|)>>|<cell|\<equallim\><rsub|<text|[theorem:
    ...
    <\eqnarray*>
      ...
      <reference|eq 17.43.138>]>>>|<cell|>>|<row|<cell|<around*|\<\|\|\>|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>i>+2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>|)>|\<\|\|\>>>|<cell|<below|\<geqslant\>|<text|[theorem:
      ...
      <reference|fundamental norm properties>]>>>|<cell|>>|<row|<cell|<around*|\||<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>i>|\|>-<around*|\<\|\|\>|2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>|)>|\<\|\|\>>>|<cell|\<equallim\><rsub|>>|<cell|>>|<row|<cell|<big|sum><rsub|i\<in\><around*|{|0,\<ldots\>,n|}>><around*|\||a<rsub|i>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>i>-2\<cdot\><around*|\<\|\|\>|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>|)>|\<\|\|\>>>|<cell|\<geqslant\>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>n>-2\<cdot\><around*|\<\|\|\>|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>>Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>|)>|\<\|\|\>>>|<cell|<below|\<geqslant\>|<text|[theorem:
      <reference|complex norm properties>(3)]>>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>n>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\||Re<around*|(|a<rsub|i>\<cdot\>z<rsup|i>\<cdot\><wide|a<rsub|j>\<cdot\>z<rsup|j>|\<wide-bar\>>|)>|\|>>|<cell|\<equallim\><rsub|<text|[lemma:
      <reference|fundamental norm properties>]>>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>n>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|Re<around*|(|a<rsub|i>\<cdot\><wide|a|\<wide-bar\>><rsub|j>\<cdot\>z<rsup|i>\<cdot\><wide|z<rsup|j>|\<wide-bar\>>|)>|\<\|\|\>>>|<cell|<below|\<geqslant\>|<text|[lemma:
      <reference|fundamental norm properties>(4)]>><rsub|>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\||z|\|><rsup|2\<cdot\>n>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z<rsup|i>\<cdot\><wide|z<rsup|j>|\<wide-bar\>>|\<\|\|\>>>|<cell|\<geqslant\><rsub|<text|[lemma:
      ...
      <reference|fundamental norm properties>]>>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\<\|\|\>|<around*|\||z|\|><rsup|2\<cdot\>n>|\<\|\|\>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>|<cell|=>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><around*|\<\|\|\>|z<rsup|n>\<cdot\><wide|z<rsup|n>|\<wide-bar\>>|\<\|\|\>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>|<cell|<below|\<geqslant\>|<text|[lemma:
      ...
      <reference|fundamental norm properties>(7)]>>>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|1|2>\<cdot\><around*|(|<frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|n>|2<rsup|n>>|)><rsup|2>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>|<cell|=>|<cell|>>|<row|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>>|<cell|>|<cell|>>>>
    </eqnarray*>

    so that\ 

    <\equation>
      <label|eq 17.44.138><around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z|)>\<geqslant\><around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\><around*|{|0,\<ldots\>,n|}><rsup|2>\|k\<less\>l|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>
    </equation>
    ...
    <\eqnarray*>
      ...
      (1)>]>>>|<cell|>>|<row|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\>B<rsub|m>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>|)>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\|k+l=m|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i+j>|)>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<subset\>A\|k+l=m|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>|)>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\>A\|k+l=m|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>|)>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>|<cell|=>|<cell|>>|<row|<cell|<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>b<rsub|m>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>|<cell|>|<cell|>>>>
    </eqnarray*>

    where <math|\<forall\>m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>
    <math|b<rsub|m>=<big|sum><rsub|<around*|(|i,j|)>\<in\><around*|{|<around*|(|k,l|)>\<in\>A\|k+l=m|}>><around*|\<\|\|\>|a<rsub|i>\<cdot\><wide|a<rsub|j>|\<wide-bar\>>|\<\|\|\>>>.
    Substituting this in [eq: <reference|eq 17.44.138>] gives\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z|)>>|<cell|\<geqslant\>>|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>-2\<cdot\><big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>b<rsub|m>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>>|<row|<cell|>|<cell|=>|<cell|<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>+<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|-2\<cdot\>b<rsub|m>|)>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>>|<row|<cell|>|<cell|=>|<cell|0\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|0>+<around*|\||a<rsub|n>|\|><rsup|2>\<cdot\><frac|<around*|\<\|\|\>|z|\<\|\|\>><rsup|2\<cdot\>n>|2<rsup|2\<cdot\>n+1>>+<big|sum><rsub|m\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>><around*|(|-2\<cdot\>b<rsub|m>|)>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|m>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|i=0><rsup|2\<cdot\>n>c<rsub|i>\<cdot\><around*|\<\|\|\>|z|\<\|\|\>><rsup|i><eq-number><label|eq
      17.45.138>>>>>
    </eqnarray*>
    ...
    <\equation*>
      ...
      >i\<in\><around*|{|1,\<ldots\>,2\<cdot\>n-1|}>>>|<row|<cell|<frac|1|2<rsup|2\<cdot\>n+1>>\<cdot\><around*|\||a<rsub|n>|\|><rsup|2><text|
      if >i=2\<cdot\>n>>>>>
    </equation*>
    ...
    [theorem: <reference|compact Heine Borel (2)>] that
    ...
    <math|<around*|\<langle\>|\<bbb-C\>,<around*|\<\|\|\>||\<\|\|\>>|\<rangle\>>>
    so that, using the above, we can apply the extreme value theorem
    [theorem: <reference|compact extreme value theorem>]. Hence there exist a
    ...
    <\description>
      ...
      <reference|eq 17.46.138>] <math|><math|<around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|0|)>\<geqslant\><rsub|<text|[eq:
    ...
    <\equation>
      <label|eq 17.50.138>\<forall\>z\<in\>\<bbb-C\><text| that >
      <around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z|)>\<geqslant\><around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z<rsub|0>|)>
    </equation>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|r\<cdot\><wide|r|\<wide-bar\>>|)><around*|(|z|)>>|<cell|=>|<cell|r<around*|(|z|)>\<cdot\><wide|r<around*|(|z|)>|\<wide-bar\>>>>|<row|<cell|>|<cell|=>|<cell|p<around*|(|z+z<rsub|0>|)>\<cdot\><wide|p<around*|(|z+z<rsub|0>|)>|\<wide-bar\>>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|p\<cdot\><wide|p|\<wide-bar\>>|)><around*|(|z+z<rsub|0>|)>>>|<row|<cell|>|<cell|\<geqslant\><rsub|<text|[eq:
    ...
    <\equation>
      ...
      <math|<around*|(|r\<cdot\><wide|r|\<wide-bar\>>|)><around*|(|z|)>-<around*|(|r\<cdot\><wide|r|\<wide-bar\>>|)><around*|(|0|)>\<geqslant\>0>>
    </equation>
    ...
    <math|k\<in\><around*|{|1,\<ldots\>,n|}>> and a polynomial of order
    <math|n-k> such that\ 
    ...
    the sum of functions composed of continuous functions defined in
    [theorem: <reference|fundamental continuity>]. So define\ 
    ...
    <\equation>
      <label|eq 17.61.139>f<rsub|x,1><around*|(|\<delta\>|)>=<around*|\<langle\>|\<cdot\>|\<rangle\>><around*|(|<around*|(|x<rsup|k>\<cdot\>|)><around*|(|q<around*|(|<around*|(|x\<cdot\>|)><around*|(|\<delta\>|)>|)>|)>|)>=<around*|\<langle\>|\<cdot\>|\<rangle\>><around*|(|<around*|(|x<rsup|k>\<cdot\>|)><around*|(|q<around*|(|x\<cdot\>\<delta\>|)>|)>|)>=<around*|\<langle\>|\<cdot\>|\<rangle\>><around*|(|x<rsup|k>\<cdot\>q<around*|(|x\<cdot\>\<delta\>|)>|)>=<around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>
    </equation>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|<around*|(|<around*|(|f<rsub|x,2>|)><rsub|\|\<bbb-R\>>+2\<cdot\><around*|(|f<rsub|x,3>|)><rsub|\|\<bbb-R\>>|)><around*|(|\<delta\>|)>>|<cell|=>|<cell|<around*|(|f<rsub|x,2>|)><rsub|\|\<bbb-R\>><around*|(|\<delta\>|)>+2\<cdot\><around*|(|f<rsub|x,3>|)><rsub|\|\<bbb-R\>><around*|(|\<delta\>|)>>>|<row|<cell|>|<cell|=>|<cell|f<rsub|x,2><around*|(|\<delta\>|)>+2\<cdot\>f<rsub|x,3><around*|(|\<delta\>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[eqs:
      <reference|eq 17.62.139>,<reference|eq
      17.63.139>]>>>|<cell|\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[eq:
    ...
    <\equation>
      ...
      >f<around*|(|\<delta\>|)>=\<delta\><rsup|k>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|\<delta\>\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>|)><text|
      is continuous>
    </equation>
    ...
    <math|<around*|\||\<delta\>|\|>=<around*|\||\<delta\>-0|\|>\<less\>\<zeta\>>
    <math|<around*|\<\|\|\>|f<rsub|x><around*|(|0|)>-f<rsub|x><around*|(|\<delta\>|)>|\<\|\|\>>\<less\>-f<around*|(|0|)>>.
    ...
    As <math|f<rsub|x><around*|(|0|)><below|\<less\>|assumption>0<below|\<leqslant\>|<text|[eq:
    <reference|eq 17.65.139>]>>f<rsub|x><around*|(|<frac|\<zeta\>|2>|)>> we
    have that <math|f<rsub|x><around*|(|<frac|\<zeta\>|2>|)>-f<rsub|x><around*|(|0|)>=<around*|\||f<rsub|x><around*|(|0|)>-f<rsub|x><around*|(|<frac|\<zeta\>|2>|)>|\|>\<less\>-f<rsub|x><around*|(|0|)>>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|0>|<cell|\<leqslant\>>|<cell|f<rsub|x><around*|(|0|)>>>|<row|<cell|>|<cell|=>|<cell|0<rsup|2>\<cdot\><around*|\||x<rsup|k>\<cdot\>q<around*|(|0\<cdot\>x|)>|\|><rsup|2>+2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|0\<cdot\>x|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|2\<cdot\>Re<around*|(|x<rsup|k>\<cdot\>q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>|\<nobracket\>>>>>>
    </eqnarray*>

    or as <math|><math|q<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>\<in\>\<bbb-C\>>
    ...
    <\description>
      ...
      <\equation*>
        0\<leqslant\>Re<around*|(|<around*|(|-1|)><rsup|k>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>=Re<around*|(|<around*|(|-1|)><rsup|2\<cdot\>m+1>\<cdot\><around*|(|a+i\<cdot\>b|)>|)>\<equallim\><rsub|<text|[theorem:
        <reference|complex power properties>]>>Re<around*|(|-a-i\<cdot\>b|)>=-a
      </equation*>
      ...
      <\description>
        ...
        <reference|eq 17.66.139>] and take in account that <math|a=0> gives\ 
        ...
        <\equation*>
          0\<leqslant\>Re<around*|(|<around*|(|-i|)><rsup|k>\<cdot\>i\<cdot\>b|)>=Re<around*|(|<around*|(|-1|)><rsup|2\<cdot\>m+1>\<cdot\>i<rsup|4\<cdot\>l+1>\<cdot\>i\<cdot\>b|)>\<equallim\><rsub|<text|[theorem:
        ...
        17.66.139>] and take in account that <math|a=0> we get

        <\equation*>
          0\<leqslant\>Re<around*|(|i<rsup|k>\<cdot\>i\<cdot\>b|)>=Re<around*|(|i<rsup|4\<cdot\>l+3>\<cdot\>i\<cdot\>b|)>\<equallim\><rsub|<text|[theorem:
          <reference|complex power of i>]>>Re<around*|(|<around*|(|-i|)>\<cdot\>i\<cdot\>b|)>=Re<around*|(|b|)>=b
        </equation*>
      ...
      So we have in all cases that <math|a=b=0> so that
      ...
      <\description>
        ...
        17.66.139>] gives, using <math|a=0>, that
        ...
        <math|k=2\<cdot\>m=4\<cdot\>l>. Substituting <math|x=1> in \ [eq:
        ...
        Take now <math|x=<around*|(|1+<frac|i|k>|)><rsup|2>> then as
        <math|k=2\<cdot\>m> we have by [lemma: <reference|lemma 17.28.136>]
        that\ 
        ...
        <math|x<rsup|k>=c+i\<cdot\>d> where
        <math|c=Re<around*|(|x<rsup|k>|)>\<in\>\<bbb-R\>> and
        <math|d=Img<around*|(|x<rsup|k>|)>\<in\>\<bbb-R\>> so that\ 
        ...
        [eq: <reference|eq 17.68.139>] <math|0\<less\>d> it follows that
    ...
    So in all cases we have <math|<wide|r<around*|(|0|)>|\<wide-bar\>>=0> so
    that <math|<around*|\||r<around*|(|0|)>|\|><rsup|2>=r<around*|(|0|)>\<cdot\><wide|r<around*|(|0|)>|\<wide-bar\>>=0>
    from which it follows that <math|r<around*|(|0|)>=0>. As by definition
    ...
    and we have proved that there exist a root of the polynomial <math|p>.\ 
  </proof>

  <\note>
    In the above proof we have used the extreme value theorem to find the
    existence of a root of <math|p> without actual providing a explicit
    expression to calculate the root of a polynomial. It is a well known fact
    that for a polynomial of a higher order then 4 there is no closed form
    general solution using radicals.\ 
  </note>
  ...
  <\theorem>
    ...
    <\equation*>
      p:\<bbb-C\>\<rightarrow\>\<bbb-C\><text| by
      >p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>
    </equation*>
  ...
  <\proof>
    ...
    <\description>
      ...
      <\description>
        ...
        <\description>
          ...
          <\equation*>
            1\<leqslant\>ord<around*|(|q|)><below|\<leqslant\>|1\<leqslant\>m\<Rightarrow\>ord<around*|(|q|)>=<around*|(|n+1|)>-m\<leqslant\>n>n,
          </equation*>

          As <math|n\<in\>S> there exist a
          <math|c\<in\>\<bbb-C\>\\<around*|{|0|}>> and a
          <math|<around*|{|y<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|q|)>|}>>\<subseteq\>\<bbb-C\>>
          ...
          <\eqnarray*>
            ...
            <reference|eq 17.76.139>]>>>|<cell|<around*|(|z-y<rsub|0>|)><rsup|m>\<cdot\>q<around*|(|z|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|i=1><rsup|m><around*|(|z-y<rsub|0>|)>|)>\<cdot\>q<around*|(|z|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|<big|prod><rsub|i=1><rsup|m><around*|(|z-z<rsub|i>|)>|)>\<cdot\>q<around*|(|z|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[eq:
    ...
    such that <math|z=z<rsub|k>>, Hence\ 

    <\eqnarray*>
      <tformat|<table|<row|<cell|p<around*|(|z|)>>|<cell|=>|<cell|p<around*|(|z<rsub|k>|)>>>|<row|<cell|>|<cell|=>|<cell|c\<cdot\><big|prod><rsub|i=1><rsup|ord<around*|(|p|)>><around*|(|z<rsub|k>-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|c\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>><around*|(|z<rsub|k>-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|c\<cdot\><big|prod><rsub|i\<in\><around*|{|k|}>><around*|(|z<rsub|k>-z<rsub|i>|)>\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k|}>><around*|(|z<rsub|k>-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|c\<cdot\><around*|(|z<rsub|k>-z<rsub|k>|)>\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|i<rsub|0>|}>><around*|(|z<rsub|k>-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|c\<cdot\>0\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|i<rsub|0>|}>><around*|(|z<rsub|k>-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|0>>>>
    </eqnarray*>
  ...
  <\lemma>
    ...
    coefficients>Let <math|p> be a polynomial then\ 

    <\equation*>
      p<text| has real coefficients >\<Leftrightarrow\><text|
      >\<forall\>x\<in\>\<bbb-R\><text| <math|p<around*|(|x|)>\<in\>\<bbb-R\>>>
    </equation*>
  </lemma>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>If <math|p> has real coefficients then
      there exist a \ <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>n>\<subseteq\>\<bbb-R\>>
      with <math|a<rsub|n>\<neq\>0> such that
      <math|\<forall\>z\<in\>\<bbb-C\>> <math|<rigid|p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>>>.
      Let <math|x\<in\>\<bbb-R\>> then we have\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|img<around*|(|p<around*|(|x|)>|)>>|<cell|=>|<cell|Img<around*|(|<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>x<rsup|i>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[example:
        ...
        <reference|complex real. imaginair
        properties>]>\<wedge\>x<rsup|i>\<in\>\<bbb-R\>>>|<cell|<big|sum><rsub|i=0><rsup|n>Img<around*|(|a<rsub|i>|)>\<cdot\>x<rsup|i>>>|<row|<cell|>|<cell|\<equallim\><rsub|a<rsub|i\<in\>\<bbb-R\>>>>|<cell|<big|sum><rsub|i=0><rsup|n>0\<cdot\>x<rsup|i>>>|<row|<cell|>|<cell|=>|<cell|0>>>>
      </eqnarray*>

      so that <math|p<around*|(|x|)>\<in\>\<bbb-R\>>.

      <item*|<math|\<Leftarrow\>>>As <math|p> is a polynomial there exist a
      <math|<around*|{|a<rsub|i>|}><rsub|i\<in\>n>\<subseteq\>\<bbb-C\>> with
      <math|a<rsub|n>\<neq\>0> such that <math|\<forall\>z\<in\>\<bbb-C\>>
      <math|<rigid|p<around*|(|z|)>=<big|sum><rsub|i=0><rsup|n>a<rsub|i>\<cdot\>z<rsup|i>>>.
      Let <math|x\<in\>\<bbb-R\>> then as
      <math|p<around*|(|x|)>\<in\>\<bbb-R\>> we have
      ...
      <\eqnarray*>
        ...
        <reference|linear mapping Img Re>]>>>|<cell|<big|sum><rsub|i=0><rsup|n>Img<around*|(|a<rsub|i>\<cdot\>x<rsup|i>|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[theorem:
        <reference|complex real. imaginair
        properties>]>\<wedge\>x<rsup|i>\<in\>\<bbb-R\>>>|<cell|<big|sum><rsub|i=0><rsup|n>Img<around*|(|a<rsub|i>|)>\<cdot\>x<rsup|i>>>>>
      </eqnarray*>
  ...
  <\theorem>
    ...
    <\note>
      If <math|m=0> then <math|<around*|{|1,\<ldots\>,m|}>=\<varnothing\>> so
      that <math|<around*|{|\<lambda\><rsub|i>|}><rsub|i\<in\>\<varnothing\>>>
  ...
  <\proof>
    ...
    <\equation*>
      ...
      then there exists a >c\<in\>\<bbb-R\>\\<around*|{|0|}><text|,
      ...
      such that <math|<rigid|\<forall\>i\<in\><around*|{|1,\<ldots\>,M|}>><text|
      we have ><around*|(|b<rsub|i>|)><rsup|2>\<less\>4\<cdot\>c<rsub|i><text|
      and >> >\<forall\>z\<in\>\<bbb-C\><text| that
    ...
    <\description>
      ...
      then <math|ord<around*|(|p|)>=1> and there exist
      <math|a<rsub|0>,a<rsub|1>\<in\>\<bbb-R\>> such that<math|>
      <math|a<rsub|1>\<neq\>0> and <math|<rigid|p<around*|(|z|)>=a<rsub|0>+a<rsub|1>\<cdot\>z>>.
      Take <math|c=a<rsub|1>\<in\>\<bbb-R\>\\<around*|{|0|}>>, <math|m=1>,
      <math|M=0>, <math|<around*|{|\<lambda\><rsub|i>|}><rsub|i<around*|{|1,\<ldots\>,m|}>><text|
      ...
      <\description>
        ...
        that<math|<text| there exists a >c\<in\>\<bbb-R\>\\<around*|{|0|}><text|,
        ><rigid|m,M\<in\>\<bbb-N\><rsub|0>><text|,
        ><rigid|<around*|{|\<lambda\><rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\>\<bbb-R\>><text|,
        ><around*|{|b<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,M|}>>\<subseteq\>\<bbb-R\><text|
        and ><around*|{|c<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,M|}>>\<subseteq\>\<bbb-R\><text|
        ...
        theorem [theorem: <reference|fundamental factorization of a
        polynomial (1)>] there exist <math|<around*|{|z<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>>\<subseteq\>\<bbb-C\>>
        and a <math|c<rprime|'>\<in\>\<bbb-C\>\\<around*|{|0|}>> such that
        ...
        <\equation>
          <label|eq 17.78.156>p<around*|(|z|)>=c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i=1><rsup|ord<around*|(|p|)>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,0|}>=\<varnothing\>><around*|(|z<rsup|2>+b<rsub|i>\<cdot\>z+c<rsub|i>|)>|)>=<rigid|c<rprime|'>\<cdot\><big|prod><rsub|i=1><rsup|ord<around*|(|p|)>><around*|(|z-z<rsub|i>|)>>
        </equation>

        Take <math|x<rsub|0>=max<around*|(|<around*|{|z<rsub|i>\|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>|}>|)>+1\<in\>\<bbb-R\>>
        then <math|\<forall\>i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>>
        <math|x<rsub|0>\<neq\>z<rsub|i>> or
        <math|<around*|(|x-x<rsub|i>|)>\<in\>\<bbb-R\>\\<around*|{|0|}>>
        proving that <math|><math|<big|prod><rsub|i=1><rsup|ord<around*|(|p|)>><around*|(|z-z<rsub|i>|)>\<in\>\<bbb-R\>\\<around*|{|0|}>>
        hence \ <math|c<rprime|'>=<frac|p<around*|(|x<rsub|0>|)>|<big|prod><rsub|i=1><rsup|ord<around*|(|p|)>><around*|(|x<rsub|0>-z<rsub|i>|)>>>.
        As by [theorem: <reference|fundamental condition for a polynomial to
        have real coefficients>] <math|p<around*|(|x<rsub|0>|)>\<in\>\<bbb-R\>>
        it follows that

        <\equation*>
          c<rprime|'>\<in\>\<bbb-R\>\\<around*|{|0|}>
        </equation*>

        Hence we have proved that <math|n+1\<in\>S> in the case where
        <math|<around*|{|z<rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,\<ldots\>,ord<around*|(|p|)>|}>>\<subseteq\>\<bbb-R\>.
        >\ 

        \;

        So we must only prove the case where there exist a
        <math|k\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>=<around*|{|1,\<ldots\>,n+1|}>>
        ...
        <math|z<rsub|k>\<in\>\<bbb-R\>> contradicting
        ...
        <\eqnarray*>
          <tformat|<table|<row|<cell|p<around*|(|z|)>>|<cell|\<equallim\><rsub|<text|[eq:
          <reference|eq 17.78.156>]>>>|<cell|c<rprime|'>\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>><around*|(|z-z<rsub|i>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|z-z<rsub|k>|)>\<cdot\><around*|(|z-z<rsub|l>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|z-z<rsub|k>|)>\<cdot\><around*|(|z-<wide|z<rsub|k>|\<wide-bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|z<rsup|2>-z\<cdot\><wide|z<rsub|k>|\<wide-bar\>>-z<rsub|k>\<cdot\>z+z<rsub|k>\<cdot\><wide|z<rsub|k>|\<wide-bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|z<rsup|2>-<around*|(|z<rsub|k>+<wide|z<rsub|k>|\<wide-bar\>>|)>\<cdot\>z+z<rsub|k>\<cdot\><wide|z<rsub|k>|\<wide-bar\>>|)>>>|<row|<cell|>|<cell|=>|<cell|c<rprime|'>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>|}>\\<around*|{|k,l|}>><around*|(|z-z<rsub|i>|)>|)>\<cdot\><around*|(|z<rsup|2>+d\<cdot\>z+e|)>>>>>
        </eqnarray*>

        where <math|d=-<around*|(|z<rsub|k>+<wide|z<rsub|k>|\<wide-bar\>>|)>=-2\<cdot\>Re<around*|(|z<rsub|k>|)>\<in\>\<bbb-R\>>
        ...
        <\equation>
          ...
          where >d=-2\<cdot\>Re<around*|(|z<rsub|k>|)>\<in\>\<bbb-R\>\<wedge\>e=<around*|\||z<rsub|k>|\|><rsup|2>\<in\>\<bbb-R\>
        </equation>

        Now as <math|z<rsub|k>\<in\>\<bbb-C\>\\\<bbb-R\>> we have that
        <math|0\<neq\>img<around*|(|z<rsub|k>|)>> so that

        <\equation*>
          d<rsup|2>=4\<cdot\><around*|(|Re<around*|(|z<rsub|k>|)>|)><rsup|2>\<less\>4\<cdot\><around*|(|Re<around*|(|z<rsub|k>|)>|)><rsup|2>+4\<cdot\><around*|(|Img<around*|(|z<rsub|k>|)>|)><rsup|2>=4\<cdot\><around*|\||z<rsub|k>|\|><rsup|2>=4\<cdot\>e
        </equation*>
        ...
        <\equation*>
          ...
          >q<around*|(|z|)>=c<rprime|'>\<cdot\><big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,ord<around*|(|p|)>-2|}>>p<rsub|i><around*|(|z|)>=c<rprime|'>\<cdot\><big|prod><rsub|i=1><rsup|ord<around*|(|p|)>-2>p<rsub|i><around*|(|x|)>=<rigid|c<rprime|'>\<cdot\><big|prod><rsub|i=1><rsup|ord<around*|(|p|)>-2><around*|(|z-z<rsub|\<beta\><around*|(|i|)>>|)>>
        </equation*>
        ...
        Using [theorem: <reference|fundamental finite product of
        polynomials>] and [lemma: <reference|lemma 17.10.155>] it follows
        that
        ...
        <math|0\<less\>e-<frac|d<rsup|2><rsub|>|4><below|\<leqslant\>|0\<leqslant\><around*|(|x+<frac|d|2>|)><rsup|2>><around*|(|x+<frac|d|2>|)><rsup|2>+e-<frac|d<rsup|2>|4>>
        and as
        ...
        we have that <math|0\<less\>x<rsup|2>+d\<cdot\>x+e\<in\>\<bbb-R\>>
        which, as <math|p<around*|(|x|)>\<in\>\<bbb-R\>>, proves that
        <math|q<around*|(|x|)>=<frac|p<around*|(|x|)>|z<rsup|2>+d\<cdot\>x+e>\<in\>\<bbb-R\>>.
        Using [theorem: <reference|fundamental condition for a polynomial to
        have real coefficients>] it follows that <math|q> has real
        coefficients, hence as <math|<rigid|ord<around*|(|q|)>=n-1\<less\>>n>
        and <math|n\<in\>S> there exist <math|c\<in\>\<bbb-R\>\\<around*|{|0|}><text|,
        >m,M<rprime|'>\<in\>\<bbb-N\><rsub|0>>,
        <math|<around*|{|\<lambda\><rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>>\<subseteq\>\<bbb-R\>>,
        <math|<rigid|<around*|{|b<rprime|'><rsub|i>|}><rsub|i\<in\><around*|{|1,\<ldots\>,M<rprime|'>|}>>\<subseteq\>\<bbb-R\>>>
        ...
        <math|<around*|(|b<rsub|i><rprime|'>|)><rsup|2>\<less\>4\<cdot\>c<rprime|'><rsub|i>>
        and

        <\equation>
          <label|eq 17.86.139>\<forall\>z\<in\>\<bbb-C\><text|
          >q<around*|(|z|)>=c\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,m|}>><around*|(|z-\<lambda\><rsub|i>|)>|)>\<cdot\><around*|(|<big|prod><rsub|i\<in\><around*|{|1,\<ldots\>,M<rprime|'>|}>><around*|(|z<rsup|2>+b<rsub|i><rprime|'>\<cdot\>z+c<rsub|i><rprime|'>|)>|)>
        </equation>

        Hence if we take <math|M=M<rprime|'>+1>,
        <math|<around*|{|c<rsub|i>|}><rsub|i\<in\>M>\<subseteq\>\<bbb-R\>> by
        <math|b<rsub|i>=<choice|<tformat|<table|<row|<cell|d<text| if
...
<\references>
  <\collection>
    ...
    <associate|divergent limit of sums|<tuple|17.16|?>>
    ...
    <associate|eq 17.39.154|<tuple|17.40|?>>
    <associate|eq 17.39.155|<tuple|17.39|?>>
    <associate|eq 17.4.135|<tuple|17.5|?>>
    <associate|eq 17.40.154|<tuple|17.41|?>>
    <associate|eq 17.41.154|<tuple|17.42|?>>
    ...
    <associate|eq 17.60.138|<tuple|17.57|?>>
    <associate|eq 17.61.139|<tuple|17.58|?>>
    <associate|eq 17.62.139|<tuple|17.59|?>>
    <associate|eq 17.63.139|<tuple|17.60|?>>
    <associate|eq 17.64.139|<tuple|17.61|?>>
    <associate|eq 17.65.139|<tuple|17.62|?>>
    <associate|eq 17.66.139|<tuple|17.63|?>>
    <associate|eq 17.67.139|<tuple|17.64|?>>
    <associate|eq 17.68.139|<tuple|17.65|?>>
    <associate|eq 17.69.139|<tuple|17.66|?>>
    <associate|eq 17.7.135|<tuple|17.8|?>>
    <associate|eq 17.70.139|<tuple|17.67|?>>
    <associate|eq 17.71.139|<tuple|17.68|?>>
    <associate|eq 17.72.139|<tuple|17.69|?>>
    <associate|eq 17.73.139|<tuple|17.70|?>>
    <associate|eq 17.74.139|<tuple|17.71|?>>
    <associate|eq 17.75.139|<tuple|17.72|?>>
    <associate|eq 17.76.139|<tuple|17.73|?>>
    <associate|eq 17.77.139|<tuple|17.74|?>>
    <associate|eq 17.78.139|<tuple|17.75|?>>
    <associate|eq 17.78.156|<tuple|17.78|?>>
    <associate|eq 17.79.139|<tuple|17.76|?>>
    <associate|eq 17.8.135|<tuple|17.9|?>>
    <associate|eq 17.80.139|<tuple|17.77|?>>
    <associate|eq 17.81.139|<tuple|17.79|?>>
    <associate|eq 17.82.139|<tuple|17.80|?>>
    <associate|eq 17.83.139|<tuple|17.81|?>>
    <associate|eq 17.84.139|<tuple|17.82|?>>
    <associate|eq 17.84.139.1|<tuple|17.83|?>>
    <associate|eq 17.86.139|<tuple|17.84|?>>
    <associate|eq 17.87.140|<tuple|17.85|?>>
    <associate|eq 17.9.135|<tuple|17.10|?>>
    <associate|fundamental binomial coefficient|<tuple|17.22|?>>
    <associate|fundamental binomial formula|<tuple|17.24|?>>
    <associate|fundamental binomial properties|<tuple|17.23|?>>
    ...
    coefficients|<tuple|17.35|?>>
    <associate|fundamental continuity|<tuple|17.19|?>>
    <associate|fundamental divergent limit|<tuple|17.14|?>>
    <associate|fundamental divergent limit of -f|<tuple|17.15|?>>
    <associate|fundamental factorial|<tuple|17.21|?>>
    <associate|fundamental factorization of a polynomial (1)|<tuple|17.34|?>>
    <associate|fundamental factorization of a polynomial (2)|<tuple|17.36|?>>
    <associate|fundamental finite product of polynomials|<tuple|17.13|?>>
    <associate|fundamental non constant polynomal|<tuple|17.9|?>>
    <associate|fundamental norm in C|<tuple|17.17|?>>
    <associate|fundamental norm properties|<tuple|17.18|?>>
    <associate|fundamental p(z)=(z-z0)|<tuple|17.33|?>>
    <associate|fundamental polynomal|<tuple|17.1|?>>
    <associate|fundamental product of polynomials is a
    polynomial|<tuple|17.12|?>>
    <associate|fundamental theorem and conjugate|<tuple|17.32|?>>
    <associate|fundamental theorem of algebra|<tuple|17.30|?>>
    <associate|lemma 17.10.155|<tuple|17.10|?>>
    <associate|lemma 17.19.136|<tuple|17.20|?>>
    <associate|lemma 17.24.136|<tuple|17.25|?>>
    <associate|lemma 17.25.136|<tuple|17.26|?>>
    <associate|lemma 17.26.136|<tuple|17.27|?>>
    <associate|lemma 17.27.136|<tuple|17.28|?>>
    <associate|lemma 17.28.136|<tuple|17.29|?>>
    <associate|lemma 17.8.145|<tuple|17.11|?>>
    <associate|lemma 17.9.155|<tuple|17.10|?>>
  </collection>
</references>
