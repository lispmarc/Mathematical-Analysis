...
<\body>
  ...
  <section|Order relation in <math|<wide|\<bbb-R\>|\<wide-bar\>>>>
  ...
  <section|Arithmetic operations on <math|<wide|\<bbb-R\>|\<wide-bar\>>>>
  ...
  <\theorem>
    ...
    <math|0\<leqslant\>y> and <math|<around*|(|x,-y|)>\<in\><around*|(|<wide|\<bbb-R\>|\<wide-bar\>>\<times\><wide|\<bbb-R\>|\<wide-bar\>>|)>\\<around*|{|<around*|(|-\<infty\>,\<infty\>|)>,<around*|(|\<infty\>,-\<infty\>|)>|}>>
    [so that <math|x-y> is well defined] then <math|x-y\<leqslant\>x>
  </theorem>

  <\proof>
    As <math|<around*|(|x,-y|)>\<in\><around*|(|<wide|\<bbb-R\>|\<wide-bar\>>\<times\><wide|\<bbb-R\>|\<wide-bar\>>|)>\\<around*|{|<around*|(|-\<infty\>,\<infty\>|)>,<around*|(|\<infty\>,-\<infty\>|)>|}>>
    and <math|0\<leqslant\>y> we have for <math|x> either:\ 

    <\description>
      <item*|<math|x=-\<infty\>>>Then <math|-y\<neq\>\<infty\>\<Rightarrow\>y\<neq\>-\<infty\>>
      so for <math|y> we have either:<space|4em>

      <\description>
        <item*|<math|y=\<infty\>>>Then <math|x-y=-\<infty\>+<around*|(|-\<infty\>|)>=-\<infty\>=x>
        so that <math|x-y\<leqslant\>x>.

        <item*|<math|y\<in\>\<bbb-R\>>>Then
        <math|x-y=-\<infty\>+<around*|(|-y|)>=-\<infty\>=x> so that
        <math|x-y\<leqslant\>x>.
      </description>

      <item*|<math|x=\<infty\>>>Then <math|-y\<neq\>-\<infty\>\<Rightarrow\>y\<neq\>\<infty\>>
      so for <math|y> we have either:

      <\description>
        <item*|<math|y=-\<infty\>>>Then <math|x-y=\<infty\>+\<infty\>=\<infty\>=x>
        so that <math|x-y\<leqslant\>x>.

        <item*|<math|y\<in\>\<bbb-R\>>>Then
        <math|x-y=\<infty\>-y=\<infty\>=x> so that <math|x-y\<leqslant\>x>.
      </description>

      <item*|<math|x\<in\>\<bbb-R\>>>Then as <math|0\<leqslant\>y> we have
      the following possible cases for <math|y>:

      <\description>
        <item*|<math|y=\<infty\>>>Then <math|x-y=x+<around*|(|-\<infty\>|)>=-\<infty\>\<leqslant\>x>
        so that <math|x-y\<leqslant\>x>.

        <item*|<math|y\<in\>\<bbb-R\>>>Then using the properties of the real
        numners we have <math|x-y\<leqslant\>x>.
      </description>
    </description>
  </proof>
  ...
  <\theorem>
    <label|extended x+y\<less\>z=\<gtr\>x\<less\>z-y>Let
    <math|<around*|(|x,y|)>\<in\><around*|(|<wide|\<bbb-R\>|\<wide-bar\>>\<times\><wide|\<bbb-R\>|\<wide-bar\>>|)>\\<around*|{|<around*|(|-\<infty\>,\<infty\>|)>,<around*|(|\<infty\>,-\<infty\>|)>|}>>
    [so that <math|x+y> is well defined, <math|z\<in\><wide|\<bbb-R\>|\<wide-bar\>>>
    such that <math|x+y\<less\>z> then

    <\equation*>
      <around*|(|z,-y|)>\<in\><around*|(|<wide|\<bbb-R\>|\<wide-bar\>>\<times\><wide|\<bbb-R\>|\<wide-bar\>>|)>\\<around*|{|<around*|(|-\<infty\>,\<infty\>|)>,<around*|(|\<infty\>,-\<infty\>|)>|}><text|
      [so that >x-y<text| is well defined]>
    </equation*>
  ...
  <\proof>
    If <math|x=\<infty\>> or <math|y=\<infty\>> then
    <math|x+y=\<infty\>\<less\>z\<leqslant\>\<infty\>> leading to the
    contradiction <math|\<infty\>\<less\>\<infty\>>. Hence we must have that

    <\equation*>
      x,y\<in\><wide|\<bbb-R\>|\<wide-bar\>>\\<around*|{|\<infty\>|}>=\<bbb-R\><big|cup><around*|{|-\<infty\>|}>\<Rightarrow\>-y\<in\>\<bbb-R\><big|cup><around*|{|\<infty\>|}>
    </equation*>

    Further If <math|z=-\<infty\>> then <math|-\<infty\>\<leqslant\>x+y\<less\>-\<infty\>>
    leading to the contradiction <math|-\<infty\>\<less\>-\<infty\>> hence we
    have that\ 

    <\equation*>
      z\<in\><wide|\<bbb-R\>|\<wide-bar\>>\\<around*|{|-\<infty\>|}>=\<bbb-R\><big|cup><around*|{|\<infty\>|}>
    </equation*>

    Hence\ 

    <\equation*>
      <around*|(|z,-y|)>\<in\><around*|(|\<bbb-R\><big|cup><around*|{|\<infty\>|}>|)>\<times\><around*|(|\<bbb-R\><big|cup><around*|{|\<infty\>|}>|)>\<subseteq\><around*|(|<wide|\<bbb-R\>|\<wide-bar\>>\<times\><wide|\<bbb-R\>|\<wide-bar\>>|)>\\<around*|{|<around*|(|-\<infty\>,\<infty\>|)>,<around*|(|\<infty\>,-\<infty\>|)>|}>
    </equation*>

    hence\ 

    <\equation*>
      z-y<text| is well defined>
    </equation*>

    For <math|z> we have then the following cases to consider:\ 

    <\description>
      <item*|<math|z\<in\>\<bbb-R\>>>For <math|x,y> we have then the
      following possible cases:\ 

      <\description>
        <item*|<math|x=-\<infty\>\<wedge\>y=-\<infty\>>>Then
        <math|x=-\<infty\>\<less\>\<infty\>=z+\<infty\>=z+<around*|(|-y|)>=z-y>
        so that <math|x\<less\>z-y>.

        <item*|<math|x\<in\>\<bbb-R\>\<wedge\>y=-\<infty\>>>Then
        <math|x\<less\>\<infty\>=z+\<infty\>=z+<around*|(|-y|)>=z-y> so that
        <math|x\<less\>z-y>.

        <item*|<math|x=-\<infty\>\<wedge\>y\<in\>\<bbb-R\>>>Then
        <math|z-y\<in\>\<bbb-R\>> so that <math|x=-\<infty\>\<less\>z-y> so
        that <math|x\<less\>z-y>.

        <item*|<math|x\<in\>\<bbb-R\>\<wedge\>y\<in\>\<bbb-R\>>>Then as
        <math|x+y\<less\>r> it follows from properties of <math|\<bbb-R\>>
        that <math|x\<less\>z-y>.
      </description>

      <item*|<math|z\<in\>\<infty\>>>For <math|x,y> we have then the
      following possible cases:\ 

      <\description>
        <item*|<math|x=-\<infty\>\<wedge\>y=-\<infty\>>>Then
        <math|x=-\<infty\>\<less\>\<infty\>=\<infty\>+\<infty\>=z+<around*|(|-y|)>=z-y>
        so that <math|x\<less\>z-y>.

        <item*|<math|x\<in\>\<bbb-R\>\<wedge\>y=-\<infty\>>>Then
        <math|x\<less\>\<infty\>=\<infty\>+\<infty\>=z+<around*|(|-y|)>=z-y>
        so that <math|x\<less\>z-y>.

        <item*|<math|x=-\<infty\>\<wedge\>y\<in\>\<bbb-R\>>>Then
        <math|x=-\<infty\>\<less\>\<infty\>=\<infty\>-y=z-y> so that
        <math|x\<less\>z-y>.

        <item*|<math|x\<in\>\<bbb-R\>\<wedge\>y\<in\>\<bbb-R\>>>Then
        <math|x\<less\>\<infty\>=\<infty\>=\<infty\>+<around*|(|-y|)>=z-y> so
        that <math|x\<less\>z-y>.
      </description>
    </description>
  ...
  <\theorem>
    <label|extended x\<less\>y-z=\<gtr\>z\<less\>y-x>Let
    <math|x,z\<in\>\<bbb-R\>\<wedge\>y\<in\><wide|\<bbb-R\>|\<wide-bar\>>>
    [so that <math|y-z> and <math|y-x> are well defined] then if
    <math|x\<less\>y-z> it follows that <math|z\<less\>y-x>
  </theorem>

  <\proof>
    If <math|y=-\<infty\>> then we have as <math|x,z\<in\>\<bbb-R\>> that
    <math|-\<infty\>\<less\>x\<less\>y-z=<around*|(|-\<infty\>|)>+<around*|(|-z|)>=-\<infty\>>
    which is a contradiction. Hence for <math|y> we have either:\ 

    <\description>
      <item*|<math|y=\<infty\>>>Then as <math|x,z\<in\>\<bbb-R\>> we have
      <math|z\<less\>\<infty\>=\<infty\>-x=y-x> which implies that
      <math|z\<less\>y-x>.

      <item*|<math|y\<in\>\<bbb-R\>>>Then as <math|x,y,z\<in\>\<bbb-R\>> we
  ...
  <section|Series of non negative sequences>
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|20|1>>
    <associate|auto-10|<tuple|<with|mode|<quote|math>|<below|lim
    inf|i\<rightarrow\>\<infty\>> x<rsub|i>>|31>>
    <associate|auto-11|<tuple|<with|mode|<quote|math>|<below|lim
    sup|i\<rightarrow\>\<infty\>> x<rsub|i>>|31>>
    <associate|auto-12|<tuple|limit in <with|mode|<quote|math>|<wide|\<bbb-R\>|\<wide-bar\>>>|41>>
    <associate|auto-13|<tuple|<with|mode|<quote|math>|<below|lim|i\<rightarrow\>\<infty\>>x<rsub|i>>|41>>
    <associate|auto-14|<tuple|20.5|60>>
    <associate|auto-15|<tuple|<with|mode|<quote|math>|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i><with|mode|<quote|text>|
    in >\<bbb-R\>>|64>>
    <associate|auto-2|<tuple|20.1|1>>
    <associate|auto-3|<tuple|20.2|6>>
    <associate|auto-4|<tuple|<with|mode|<quote|math>|<wide|\<bbb-R\><rsup|>|\<wide-bar\>><rsup|+>>|8>>
    <associate|auto-5|<tuple|<with|mode|<quote|math>|<wide|\<bbb-R\>|\<wide-bar\>><rsup|+><rsub|0>>|8>>
    <associate|auto-6|<tuple|<with|mode|<quote|math>|<around*|\<langle\>|<wide|\<bbb-R\>|\<wide-bar\>><rsup|+><rsub|0>,+|\<rangle\>>>|8>>
    <associate|auto-7|<tuple|20.3|21>>
    <associate|auto-8|<tuple|<with|mode|<quote|math>|\<cal-T\><rsub|<wide|\<bbb-R\>|\<wide-bar\>>>>|24>>
    <associate|auto-9|<tuple|20.4|30>>
    <associate|eq 20.1.155|<tuple|20.1|24>>
    <associate|eq 20.10.155|<tuple|20.10|35>>
    <associate|eq 20.11.155|<tuple|20.11|35>>
    <associate|eq 20.12.155|<tuple|20.12|36>>
    <associate|eq 20.13.155|<tuple|20.14|37>>
    <associate|eq 20.13.156|<tuple|20.13|37>>
    <associate|eq 20.14.155|<tuple|20.15|37>>
    <associate|eq 20.16.156|<tuple|20.16|38>>
    <associate|eq 20.17.156|<tuple|20.17|39>>
    <associate|eq 20.18.156|<tuple|20.18|39>>
    <associate|eq 20.19.156|<tuple|20.19|41>>
    <associate|eq 20.2.155|<tuple|20.2|24>>
    <associate|eq 20.20.156|<tuple|20.20|42>>
    <associate|eq 20.21.156|<tuple|20.21|42>>
    <associate|eq 20.22.156|<tuple|20.22|42>>
    <associate|eq 20.23.156|<tuple|20.23|42>>
    <associate|eq 20.24\<point\>156|<tuple|20.24|43>>
    <associate|eq 20.25.156|<tuple|20.25|43>>
    <associate|eq 20.26.156|<tuple|20.26|44>>
    <associate|eq 20.27.156|<tuple|20.27|45>>
    <associate|eq 20.28.156|<tuple|20.28|55>>
    <associate|eq 20.29.156|<tuple|20.29|55>>
    <associate|eq 20.3.155|<tuple|20.3|24>>
    <associate|eq 20.30.156|<tuple|20.30|55>>
    <associate|eq 20.31.156|<tuple|20.31|55>>
    <associate|eq 20.32.156|<tuple|20.32|60>>
    <associate|eq 20.32.156.1|<tuple|20.33|60>>
    <associate|eq 20.34.156|<tuple|20.34|61>>
    <associate|eq 20.35.156|<tuple|20.35|61>>
    <associate|eq 20.36.156|<tuple|20.36|61>>
    <associate|eq 20.37.156|<tuple|20.37|61>>
    <associate|eq 20.38.156|<tuple|20.38|64>>
    <associate|eq 20.39.156|<tuple|20.40|66>>
    <associate|eq 20.39.201|<tuple|20.39|66>>
    <associate|eq 20.4.155|<tuple|20.4|30>>
    <associate|eq 20.40.156|<tuple|20.41|67>>
    <associate|eq 20.41.156|<tuple|20.42|67>>
    <associate|eq 20.42.156|<tuple|20.43|69>>
    <associate|eq 20.43.156|<tuple|20.44|70>>
    <associate|eq 20.44.156|<tuple|20.45|70>>
    <associate|eq 20.45.156|<tuple|20.46|72>>
    <associate|eq 20.46.156|<tuple|20.47|73>>
    <associate|eq 20.47.156|<tuple|20.48|73>>
    <associate|eq 20.48.156|<tuple|20.49|74>>
    <associate|eq 20.49.156|<tuple|20.50|74>>
    <associate|eq 20.5.155|<tuple|20.5|30>>
    <associate|eq 20.50.156|<tuple|20.51|74>>
    <associate|eq 20.51.156|<tuple|20.52|75>>
    <associate|eq 20.6.155|<tuple|20.6|32>>
...
<\auxiliary>
  <\collection>
    <\associate|idx>
      <tuple|<tuple|<with|mode|<quote|math>|<wide|\<bbb-R\><rsup|>|\<wide-bar\>><rsup|+>>>|<pageref|auto-4>>

      <tuple|<tuple|<with|mode|<quote|math>|<wide|\<bbb-R\>|\<wide-bar\>><rsup|+><rsub|0>>>|<pageref|auto-5>>

      <tuple|<tuple|<with|mode|<quote|math>|<around*|\<langle\>|<wide|\<bbb-R\>|\<wide-bar\>><rsup|+><rsub|0>,+|\<rangle\>>>>|<pageref|auto-6>>

      <tuple|<tuple|<with|mode|<quote|math>|\<cal-T\><rsub|<wide|\<bbb-R\>|\<wide-bar\>>>>>|<pageref|auto-8>>

      <tuple|<tuple|<with|mode|<quote|math>|<below|lim
      inf|i\<rightarrow\>\<infty\>> x<rsub|i>>>|<pageref|auto-10>>

      <tuple|<tuple|<with|mode|<quote|math>|<below|lim
      sup|i\<rightarrow\>\<infty\>> x<rsub|i>>>|<pageref|auto-11>>

      <tuple|<tuple|limit in <with|mode|<quote|math>|<wide|\<bbb-R\>|\<wide-bar\>>>>|<pageref|auto-12>>

      <tuple|<tuple|<with|mode|<quote|math>|<below|lim|i\<rightarrow\>\<infty\>>x<rsub|i>>>|<pageref|auto-13>>

      <tuple|<tuple|<with|mode|<quote|math>|<big|sum><rsub|i=k><rsup|\<infty\>>x<rsub|i><with|mode|<quote|text>|
      in >\<bbb-R\>>>|<pageref|auto-15>>
    </associate>
    <\associate|toc>
