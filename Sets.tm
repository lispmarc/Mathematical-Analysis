...
<\body>
  ...
  <\definition>
    ...
    <math|f,g> be two graphs then <math|g\<circ\>f> is defined by
  ...
  <math|A>. This is expressed in the following theorem
  ...
  <\proof>
    As <math|f:A\<rightarrow\>B> and <math|g:C\<rightarrow\>D> are functions
    then we have that\ 

    <\equation*>
      f\<subseteq\>A\<times\>B\<wedge\><around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>f\<Rightarrow\>y=y<rprime|'>
    </equation*>

    <\equation*>
      g\<subseteq\>C\<times\>D\<wedge\><around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>g\<Rightarrow\>y=y<rprime|'>
    </equation*>

    <\equation*>
      A=dom<around*|(|f|)>\<wedge\>B=dom<around*|(|g|)>
    </equation*>

    Let <math|<around*|(|x,y|)>\<in\>g\<circ\>f> then <math|\<exists\>z> with
    <math|<around*|(|x,z|)>\<in\>f> and <math|<around*|(|z,y|)>\<in\>g>. As
    <math|f\<subseteq\>A\<times\>B> and <math|g\<subseteq\>C\<times\>D> it
    follows that \ <math|x\<in\>A\<wedge\>z\<in\>C\<wedge\>y\<in\>D>. As
    <math|z\<in\>C> and <math|<around*|(|x,z|)>\<in\>f> it follows that
    <math|x\<in\>f<rsup|-1><around*|(|C|)>>. So we have
    <math|<around*|(|x,y|)>\<in\><around*|(|A<big|cap>f<rsup|-1><around*|(|C|)>|)>\<times\>D>.
    Hence we have that\ 

    <\equation*>
      g\<circ\>f\<subseteq\><around*|(|A<big|cap>f<rsup|-1><around*|(|C|)>|)>\<times\>D
    </equation*>

    Further we have if <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>g\<circ\>f>
    that there exist <math|z,z<rprime|'>> such that
    <math|<around*|(|x,z|)>\<in\>f>, <math|<around*|(|z,y|)>\<in\>g>,
    <math|<around*|(|x,z<rprime|'>|)>\<in\>f> and
    <math|<around*|(|z<rprime|'>,y<rprime|'>|)>\<in\>g>. As
    <math|<around*|(|x,z|)>,<around*|(|z,z<rprime|'>|)>\<in\>f> it follows
    that <math|z=z<rprime|'>> so that <math|<around*|(|z,y|)>,<around*|(|z,y<rprime|'>|)>\<in\>g>
    hence <math|y=y<rprime|'>>. So we conclude that\ 

    <\equation>
      <label|eq 2.14.141>g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D<text|
      is a partial function>
    </equation>

    Now if <math|x\<in\>dom<around*|(|g\<circ\>f|)>> then there exist a
    <math|z> such that <math|<around*|(|x,z|)>\<in\>g\<circ\>f\<subseteq\><around*|(|A<big|cap>f<rsup|-1><around*|(|C|)>|)>\<times\>D>
    so that <math|x\<in\>A<big|cap>f<rsup|-1><around*|(|C|)>> proving that\ 

    <\equation>
      <label|eq 2.15.141>dom<around*|(|g\<circ\>f|)>\<subseteq\>A<big|cap>f<rsup|-1><around*|(|C|)>
    </equation>

    Further if <math|x\<in\>A<big|cap>f<rsup|-1><around*|(|C|)>> then
    <math|x\<in\>A> and there exist a <math|z\<in\>C> such that
    <math|<around*|(|x,z|)>\<in\>f>. As <math|z\<in\>C=dom<around*|(|g|)>>
    there exist a <math|z<rprime|'>> such that
    <math|<around*|(|z,z<rprime|'>|)>\<in\>g.> Hence by definition
    <math|*<around*|(|x,z<rprime|'>|)>\<in\>g\<circ\>f> so that
    <math|x\<in\>dom<around*|(|g\<circ\>f|)>>. So we conclude that
    <math|><math|A<big|cap>f<rsup|-1><around*|(|C|)>\<subseteq\>dom<around*|(|g\<circ\>f|)>>
    or using [eq: <reference|eq 2.15.141>]\ 

    <\equation*>
      dom<around*|(|g\<circ\>f|)>=A<big|cap>f<rsup|-1><around*|(|C|)>
    </equation*>

    Combining the above with [eqs: <reference|eq 2.14.141>, <reference|eq
    2.15.141>] proves that\ 

    <\equation*>
      g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D<text| is
      a function>
    </equation*>

    If <math|y\<in\>range<around*|(|g\<circ\>f|)>> then there exist a
    <math|x> such that <math|<around*|(|x,y|)>\<in\>g\<circ\>f>, hence there
    exist a <math|z> such that <math|<around*|(|x,z|)>\<in\>f> and
    <math|<around*|(|z,y|)>\<in\>g>. As <math|<around*|(|x,z|)>\<in\>f> it
    follows that <math|z\<in\>range<around*|(|f|)>>, so as
    <math|<around*|(|z,y|)>\<in\>g> it follows that
    <math|y\<in\>g<around*|(|range<around*|(|f|)>|)>> which proves that\ 

    <\equation>
      <label|eq 2.16.141>range<around*|(|g\<circ\>f|)>\<subseteq\>g<around*|(|range<around*|(|f|)>|)>
    </equation>

    On the other hand if <math|y\<in\>g<around*|(|range<around*|(|f|)>|)>>
    then there exist a <math|x\<in\>range<around*|(|f|)>> such that
    <math|<around*|(|x,y|)>\<in\>g>. As <math|x\<in\>range<around*|(|f|)>>
    there exist a <math|z> such that <math|<around*|(|z,x|)>\<in\>f>. Hence
    <math|<around*|(|z,y|)>\<in\>g\<circ\>f> so that
    <math|y\<in\>range<around*|(|g\<circ\>f|)>> proving that
    <math|g<around*|(|range<around*|(|f|)>|)>\<subseteq\>range<around*|(|g\<circ\>f|)>>.
    Combining this with [eq: <reference|eq 2.16.141>] proves that\ 

    <\equation*>
      range<around*|(|g\<circ\>f|)>=g<around*|(|range<around*|(|f|)>|)>
    </equation*>
  ...
  <\theorem>
    <label|function composition of functions is a fucntion (1)>Let
  ...
  <\proof>
    ...
    <\equation>
      <label|eq 2.17.141>g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D<text|
      is a function and >range<around*|(|g\<circ\>f|)>=g<around*|(|range<around*|(|f|)>|)>
    </equation>

    Further as <math|f<around*|(|A|)>\<subseteq\>C> we have by [theorem:
    <reference|partial functions image/preimage properties>] that
    <math|f<rsup|-1><around*|(|f<around*|(|A|)>|)>\<subseteq\>f<rsup|-1><around*|(|C|)>>
    which as <math|A\<subseteq\><rsub|<text|[theorem: <reference|function
    preimage of image (1)>]>>f<rsup|-1><around*|(|f<around*|(|A|)>|)>> proves
    that <math|A\<subseteq\>f<rsup|-1><around*|(|C|)>>. But then
    <math|A<big|cap>f<rsup|-1><around*|(|C|)>=A> and substituting this in
    [eq: <reference|eq 2.17.141>] \ proves that\ 

    <\equation*>
      g\<circ\>f:A\<rightarrow\>D<text| is a function with
      >range<around*|(|g\<circ\>f|)>=g<around*|(|range<around*|(|f|)>|)>
    </equation*>
  </proof>
  ...
  <\corollary>
    <label|function inverse of Id>If <math|A> is a set then we have for the
    bijection <math|Id<rsub|U>:A\<rightarrow\>A> [see theorem:
    <reference|function identity map is a bijection>] that
    <math|<around*|(|Id<rsub|U>|)><rsup|-1>=Id<rsub|U>>.
  </corollary>

  <\proof>
    As we have for <math|Id<rsub|U>:A\<rightarrow\>A> that
    <math|Id<rsub|A>\<circ\>Id<rsub|A><below|=|<text|[theorem:
    <reference|function composition of Id function>]>>Id<rsub|A>> it follows
    from [proposition: <reference|function inverse of a bijection is unique>]
    that <math|<around*|(|Id<rsub|U>|)><rsup|-1>=Id<rsub|U>>.
  </proof>
  ...
  We show now the relation between composition and restriction.

  <\theorem>
    <label|function restriction and composition>If <math|f:A\<rightarrow\>B>
    and <math|g:C\<rightarrow\>D> are functions [so that by [theorem:
    <reference|function composition of functions is a fucntion>]
    <math|<rigid|g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D>>
    is a function] \ then

    <\equation*>
      g\<circ\>f=g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>
    </equation*>

    so that\ 

    <\equation*>
      g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D
    </equation*>

    is also a function that is equal to the function

    <\equation*>
      g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D
    </equation*>
  </theorem>

  <\proof>
    As by [theorem: <reference|function composition of functions is a
    fucntion>] <math|g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D>
    ...
    Let <math|<around*|(|x,y|)>\<in\>g\<circ\>f> then there exist a <math|z>
    such that <math|<around*|(|x,z|)>\<in\>f> and
    <math|<around*|(|z,y|)>\<in\>g>. Further, as
    <math|<around*|(|x,y|)>\<in\>g\<circ\>f> and
    <math|g\<circ\>f\<subseteq\><around*|(|A<big|cap>f<rsup|-1><around*|(|C|)>|)>\<times\>D>,
    it follows that <math|x\<in\>A<big|cap>f<rsup|-1><around*|(|C|)>>, so
    that <math|<around*|(|x,z|)>\<in\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>>
    and as <math|<around*|(|z,y|)>\<in\>g> that
    <math|<around*|(|x,y|)>\<in\>g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>>.
    Hence we must conclude that\ 

    <\equation>
      <label|eq 2.25.141>g\<circ\>f\<subseteq\>g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>
    </equation>

    On the other hand if <math|<around*|(|x,y|)>\<in\>g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>>
    then there exist a <math|z> such that
    <math|<around*|(|x,z|)>\<in\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>>
    and <math|<around*|(|z,x|)>\<in\>g>. Hence by the definition of
    <math|f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>> it follows that
    <math|<around*|(|x,z|)>\<in\>f> so that, as
    <math|<around*|(|z,x|)>\<in\>g> it follows that
    <math|<around*|(|x,y|)>\<in\>g\<circ\>f>. Hence
    <math|g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>\<subseteq\>g\<circ\>f>
    which combined with [eq: <reference|eq 2.25.141>] proves finally that\ 
  ...
  <\corollary>
    <label|function restriction and composition (1)>If
    <math|f:A\<rightarrow\>B> and <math|g:C\<rightarrow\>D> are functions
    such that <math|C\<subseteq\>B> then\ 

    <\equation*>
      g\<circ\>f:f<rsup|-1><around*|(|C|)>\<rightarrow\>D<text| is a function
      >
    </equation*>
    ...
    <\equation*>
      g\<circ\>f=g\<circ\>f<rsub|\|f<rsup|-1><around*|(|C|)>>
    </equation*>

    so that

    <\equation*>
      g\<circ\>f<rsub|\|f<rsup|-1><around*|(|C|)>>:f<rsup|-1><around*|(|C|)>\<rightarrow\>D
    </equation*>

    is also a function that is equal to the function

    <\equation*>
      g\<circ\>f:f<rsup|-1><around*|(|C|)>\<rightarrow\>D
    </equation*>
  </corollary>

  <\proof>
    As <math|f:A\<rightarrow\>B> is a function it follows from [theorem:
    <reference|function image preimage>(4)] that\ 

    <\equation*>
      A=f<rsup|-1><around*|(|B|)>
    </equation*>

    Further as <math|C\<subseteq\>B> it follows from [theorem:
    <reference|partial functions image/preimage properties>(6)] that
    <math|f<rsup|-1><around*|(|C|)>\<subseteq\>f<rsup|-1><around*|(|B|)>>
    which by the above proves that\ 

    <\equation*>
      f<rsup|-1><around*|(|C|)>\<subseteq\>A
    </equation*>

    Hence using [theorem: <reference|class inclusion and union and
    intersection>(2)] it follows that\ 

    <\equation>
      <label|eq 2.26\<point\>1>A<big|cap>f<rsup|-1><around*|(|C|)>=f<rsup|-1><around*|(|C|)>
    </equation>

    Now using [theorem: <reference|function composition of functions is a
    fucntion>] <math|g\<circ\>f:A<big|cap>f<rsup|-1><around*|(|C|)>\<rightarrow\>D>
    is a function so that by the above

    <\equation*>
      g\<circ\>f:f<rsup|-1><around*|(|C|)>\<rightarrow\>D<text| is a
      function>
    </equation*>

    Further by the previous theorem [see theorem: <reference|function
    restriction and composition>] we have that
    <math|g\<circ\>f=g\<circ\>f<rsub|\|A<big|cap>f<rsup|-1><around*|(|C|)>>>
    so that by [eq: <reference|eq 2.26\<point\>1>]\ 
  ...
  <\proof>
    ...
    <\enumerate>
      <item>First as <math|f\<subseteq\>A\<times\>C> and
      <math|g\<subseteq\>B\<times\>C> then we have that\ 
      ...
      Second if <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>f<big|cup>g>
      then we have either:\ 

      <\description>
        <item*|<math|x\<in\>A\\B>>Then <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<nin\>B\<times\>C\<Rightarrow\><around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<nin\>g>
        so that <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>f>
        which as <math|f> is a function proves that <math|y=y<rprime|'>>.

        <item*|<math|x\<in\>B\\A>>Then <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<nin\>A\<times\>C\<Rightarrow\><around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<nin\>f>
        so that <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>g>
        which as <math|g> is a function proves that <math|y=y<rprime|'>>.

        <item*|<math|x\<in\>B\\A>>As <math|<around*|(|x,y|)>,<around*|(|x,y<rprime|'>|)>\<in\>f<big|cup>g>
        we have either:\ 

        <\description>
          <item*|<math|<around*|(|x,y|)>\<in\>f>>Then we have either:

          <\description>
            <item*|<math|<around*|(|x,y<rprime|'>|)>\<in\>f>>As <math|f> is a
            function we have that <math|y=y<rprime|'>>

            <item*|<math|<around*|(|x,y<rprime|'>|)>\<in\>g>>Then we have by
            the extra condition on <math|x\<in\>A<big|cap>B> that
            <math|y=y<rprime|'>>.
          </description>

          <item*|<math|<around*|(|x,y|)>\<in\>g>>Then we have either:

          <\description>
            <item*|<math|<around*|(|x,y<rprime|'>|)>\<in\>f>>Then we have by
            the extra condition on <math|x\<in\>A<big|cap>B> that
            <math|y=y<rprime|'>>.

            <item*|<math|<around*|(|x,y<rprime|'>|)>\<in\>g>>As <math|g> is a
            function we have that <math|y=y<rprime|'>>
          </description>
        </description>
      </description>
      ...
      Let <math|x\<in\>A<big|cup>B> then we have either:\ 

      <\description>
        <item*|<math|x\<in\>A>>As <math|f> is a function there exist a
        <math|y\<in\>C> such that <math|<around*|(|x,y|)>\<in\>f\<subseteq\>f<big|cup>g>.

        <item*|<math|x\<in\>B>>As <math|g> is a function there exist a
        <math|y\<in\>C> such that <math|<around*|(|x,y|)>\<in\>g\<subseteq\>f<big|cup>g>.
      </description>

      So in all cases we found a <math|y\<in\>C> such that
      <math|<around*|(|x,y|)>\<in\>f<big|cup>g> which proves that\ 

      <\equation*>
        f<big|cup>g<text| is a function>
      </equation*>

      <item>Let <math|x\<in\><around*|(|f<big|cup>g|)><rsup|-1><around*|(|D|)>>
      then there exist a <math|y\<in\>D> such that
      <math|<around*|(|x,y|)>\<in\>f<big|cup>g>. Hence we have either
      <math|<around*|(|x,y|)>\<in\>f\<Rightarrow\>x\<in\>f<rsup|-1><around*|(|D|)>>
      or <math|<around*|(|x,y|)>\<in\>g\<Rightarrow\>x\<in\>g<rsup|-1><around*|(|D|)>>
      so that <math|x\<in\>f<rsup|-1><around*|(|D|)>> or
      <math|x\<in\>g<rsup|-1><around*|(|D|)>>. Hence we have proved that\ 

      <\equation>
        <label|eq 2.28.401><around*|(|f<big|cup>g|)><rsup|-1><around*|(|D|)>\<subseteq\>f<rsup|-1><around*|(|D|)><big|cup>g<rsup|-1><around*|(|D|)>
      </equation>

      On the other hand if <math|x\<in\>f<rsup|-1><around*|(|D|)><big|cup>g<rsup|-1><around*|(|D|)>>
      then we have either:\ 

      <\description>
        <item*|<math|x\<in\>f<rsup|-1><around*|(|D|)>>>Then there exist a
        <math|y\<in\>D> such that <math|<around*|(|x,y|)>\<in\>f\<subseteq\>f<big|cup>g\<Rightarrow\>x\<in\><around*|(|f<big|cup>g|)><rsup|-1><around*|(|D|)>>

        <item*|<math|x\<in\>g<rsup|-1><around*|(|D|)>>>Then there exist a
        <math|y\<in\>D> such that <math|<around*|(|x,y|)>\<in\>g\<subseteq\>f<big|cup>g\<Rightarrow\>x\<in\><around*|(|f<big|cup>g|)><rsup|-1><around*|(|D|)>>
      </description>

      hence in all possible cases we have
      <math|x\<in\><around*|(|f<big|cup>g|)><rsup|-1><around*|(|D|)>> which
      proves that
  ...
  <\proof>
    ...
    <math|x\<in\>dom<around*|(|f|)>> which as
    <math|dom<around*|(|f|)>\<subseteq\>C> proves that <math|x\<in\>C> hence
    <math|<around*|(|x,y|)>\<in\><around*|{|z\|z=<around*|(|x,y|)>\<in\>f\|x\<in\>C|}>=f<rsub|\|C>>.
    Further if <math|<around*|(|x,y|)>\<in\>f<rsub|\|C>> then
    <math|<around*|(|x,y|)>\<in\>f> and <math|x\<in\>C>, so evidently
    <math|<around*|(|x,y|)>\<in\>f>. Hence using the Axiom of Extent [axiom:
    <reference|axiom of extent>] we have\ 
  ...
  <\theorem>
    ...
    functions, <math|E\<subseteq\>A> and <math|f<around*|(|E|)>\<subseteq\>F>
    then

    <\equation*>
      <around*|(|g\<circ\>f|)><rsub|\|E>=g<rsub|\|F>\<circ\>f<rsub|\|E>
    </equation*>

    <\note>
      If <math|f<around*|(|E|)>\<subseteq\>dom<around*|(|g|)>> then, as by
      [theorem: <reference|function restriction and domain>]
      <math|g<rsub|\|dom<around*|(|g|)>>=g> we have in this special cases
      that\ 
  ...
  <\proof>
    Let <math|<around*|(|x,y|)>\<in\><around*|(|g\<circ\>f|)><rsub|\|E>> then
    <math|<around*|(|x,y|)>\<in\>g\<circ\>f> and <math|x\<in\>E>, hence
    <math|\<exists\>y> such that <math|<around*|(|x,y|)>\<in\>f\<wedge\><around*|(|y,z|)>\<in\>g>.
    As <math|x\<in\>E> it follows that <math|<around*|(|x,y|)>\<in\>f<rsub|\|E>>,
    further from <math|x\<in\>E> and <math|<around*|(|x,y|)>\<in\>f> it
    follows that <math|y\<in\>f<around*|(|E|)><below||>> or, \ as
    <math|f<around*|(|E|)>\<subseteq\>F>, it follows that <math|y\<in\>F> so
    that <math|<around*|(|y,z|)>\<in\>g<rsub|\|F>>. Hence we have that
    <math|<around*|(|x,z|)>\<in\>g<rsub|\|F>\<circ\>f<rsub|\|E>> which proves
    that\ 

    <\equation>
      <label|eq 2.31.400><around*|(|g\<circ\>f|)><rsub|\|E>\<subseteq\>g<rsub|\|F>\<circ\>f<rsub|\|E>
    </equation>

    If <math|<around*|(|x,y|)>\<in\>g<rsub|\|F>\<circ\>f<rsub|\|E>> then
    there exist a <math|y> such that <math|<around*|(|x,y|)>\<in\>f<rsub|\|E>>
    and <math|<around*|(|y,z|)>\<in\>g<rsub|\|F>>. Hence
    <math|<around*|(|x,y|)>\<in\>f\<wedge\>x\<in\>E> and
    <math|<around*|(|y,z|)>\<in\>g> so that
    <math|<around*|(|x,y|)>\<in\>g\<circ\>f> and <math|x\<in\>E> which proves
    that <math|<around*|(|x,y|)>\<in\><around*|(|g\<circ\>f|)><rsub|\|E>>. So
    <math|g<rsub|\|F>\<circ\>f<rsub|\|E>\<subseteq\><around*|(|g\<circ\>f|)><rsub|\|E>>
    which combined with [eq: <reference|eq 2.31.400>] proves that\ 

    <\equation*>
      <around*|(|g\<circ\>f|)><rsub|\|E>\<subseteq\>g<rsub|\|F>\<circ\>f<rsub|\|E>
    </equation*>
  </proof>
  ...
  <\theorem>
    <label|function composition of function and inverse function>Let
    <math|f:A\<rightarrow\>B> and <math|g:C\<rightarrow\>D> be injective
    functions then we have\ 
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        ...
        restriction>]>>>|<cell|f<rsub|\|g<rsup|-1><around*|(|g<around*|(|A<big|cap>C|)>|)>>\<circ\><around*|(|g<rsup|-1>|)><rsub|\|g<around*|(|A<big|cap>C|)>>>>|<row|<cell|>|<cell|<below|=|<text|[proposition:
        <reference|function preimage of image>]>>>|<cell|f<rsub|\|A<big|cap>C>\<circ\><around*|(|g<rsup|-1>|)><rsub|\|g<around*|(|A<big|cap>C|)>>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[theorem:
  ...
  <\definition>
    ...
    and <math|R> a equivalence relation then <math|A/R> is defined by\ 
  ...
  <\theorem>
    <label|equivalence relation defines a partition (1)>Let <math|A> be a set
    and <math|R> a equivalence relation then\ 

    <\equation*>
      A=<big|cup><rsub|I\<in\>A/R>I<text| and <math|\<forall\>I,J\<in\>A/R>
      with >I\<neq\>J<text| we have >I<big|cap>J=\<varnothing\>
    </equation*>
  </theorem>

  <\proof>
    If <math|x\<in\>A> then by [theorem: <reference|equivalence relation
    R[x]=R[y]>] \ <math|x\<in\>R<around*|[|x|]>\<in\>A/R> so that
    <math|x\<in\><big|cup><rsub|I\<in\>A/R>I> hence\ 

    <\equation*>
      A\<subseteq\><big|cup><rsub|I\<in\>A/R>I
    </equation*>

    Further, as <math|\<forall\>I\<in\>A/R> we have that
    <math|\<exists\>x\<in\>A> such that <math|I=R<around*|[|x|]>\<subseteq\>A>,
    it follows that <math|<big|cup><rsub|I\<in\>A/R>I\<subseteq\>A> which
    combined with the above gives\ 

    <\equation*>
      A=<big|cup><rsub|I\<in\>A/R>I
    </equation*>

    Further if <math|I,J\<in\>A/R> with <math|I\<neq\>J> then
    <math|\<exists\>x,y\<in\>A> such that <math|I=R<around*|[|x|]>> and
    <math|J=R<around*|[|y|]>>. If <math|z\<in\>R<around*|[|x|]><big|cap>R<around*|[|y|]>>
    then by [theorem: <reference|equivalence relation R[x]=R[y]>] we have
    <math|R<around*|[|x|]>=R<around*|[|z|]>=R<around*|[|y|]>> so that
    <math|I=J> contradicting <math|I\<neq\>J>. Hence we must have that\ 
  ...
  <\example>
    ...
    <math|min<around*|(|<around*|{|x,y|}>|)>> exist.
  </example>

  <\proof>
    As <math|<around*|\<langle\>|X,\<leqslant\>|\<rangle\>>> is a totally
    ordered set we have either:

    <\description>
      <item*|<math|x\<leqslant\>y>>Then as <math|x,y\<in\>X>,
      <math|x\<leqslant\>x>, <math|y\<leqslant\>y> and <math|x\<leqslant\>y>
      we have <math|min<around*|(|<around*|{|x,y|}>|)>=x> and
      <math|max<around*|(|<around*|{|x,y|}>|)>=y>.

      <item*|<math|y\<leqslant\>x>>Then as <math|x,y\<in\>X>,
      <math|x\<leqslant\>x>, <math|y\<leqslant\>y> and <math|y\<leqslant\>x>
      we have <math|min<around*|(|<around*|{|x,y|}>|)>=y> and
  ...
  <\theorem>
    ...
    be a totally ordered set and <math|A\<subseteq\>X>, <math|B\<subseteq\>X>
    then we have:

    <\enumerate>
      <item>If <math|max<around*|(|A|)>> and <math|max<around*|(|B|)>> exist
      then <math|max<around*|(|A<big|cup>B|)>> exist and

      <\equation*>
        max<around*|(|A<big|cup>B|)>=max<around*|(|<around*|{|max<around*|(|A|)>,max<around*|(|B|)>|}>|)>
      </equation*>

      <item>If <math|min<around*|(|A|)>> and <math|min<around*|(|B|)>> exist
      then <math|min<around*|(|A<big|cup>B|)>> exist and

      <\equation*>
        min<around*|(|A<big|cup>B|)>=min<around*|(|<around*|{|min<around*|(|A|)>,min<around*|(|B|)>|}>|)>
      </equation*>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>We have the following possibilities for <math|max<around*|(|A|)>>
      and <math|max<around*|(|B|)>>:

      <\description>
        <item*|<math|max<around*|(|A|)>\<leqslant\>max<around*|(|B|)>>>Then
        <math|max<around*|(|B|)>\<in\>B\<subseteq\>A<big|cup>B> and
        <math|\<forall\>x\<in\>A<big|cup>B> we have either:

        <\description>
          <item*|<math|x\<in\>A>>Then <math|x\<leqslant\>max<around*|(|A|)>\<leqslant\>max<around*|(|B|)>>
          so that <math|x\<leqslant\>max<around*|(|B|)>>

          <item*|<math|x\<in\>B>>Then <math|x\<leqslant\>max<around*|(|B|)>>
        </description>

        Hence <math|\<forall\>x\<in\>A<big|cup>B> we have that
        <math|x\<leqslant\>max<around*|(|B|)>> proving that\ 

        <\equation*>
          max<around*|(|A<big|cup>B|)>=max<around*|(|B|)>\<equallim\><rsub|<text|[example:
          <reference|order min({x,y})>]>>max<around*|(|<around*|{|max<around*|(|A|)>,max<around*|(|B|)>|}>|)>
        </equation*>

        <item*|<math|max<around*|(|B|)>\<leqslant\>max<around*|(|A|)>>>Then
        <math|max<around*|(|A|)>\<in\>A\<subseteq\>A<big|cup>B> and
        <math|\<forall\>x\<in\>A<big|cup>B> we have either:

        <\description>
          <item*|<math|x\<in\>A>>Then <math|x\<leqslant\>max<around*|(|A|)>>

          <item*|<math|x\<in\>B>>Then <math|x\<leqslant\>max<around*|(|B|)>\<leqslant\>max<around*|(|A|)>>
        </description>

        Hence <math|\<forall\>x\<in\>A<big|cup>B> we have that
        <math|x\<leqslant\>max<around*|(|A|)>> proving that\ 

        <\equation*>
          max<around*|(|A<big|cup>B|)>=max<around*|(|A|)>\<equallim\><rsub|<text|[example:
          <reference|order min({x,y})>]>>max<around*|(|<around*|{|max<around*|(|A|)>,max<around*|(|B|)>|}>|)>
        </equation*>
      </description>

      <item>We have the following possibilities for <math|min<around*|(|A|)>>
      and <math|min<around*|(|B|)>>:

      <\description>
        <item*|<math|min<around*|(|A|)>\<leqslant\>min<around*|(|B|)>>>Then
        <math|min<around*|(|A|)>\<in\>A\<subseteq\>A<big|cup>B> and
        <math|\<forall\>x\<in\>A<big|cup>B> we have either:

        <\description>
          <item*|<math|x\<in\>A>>Then <math|min<around*|(|A|)>\<leqslant\>x>

          <item*|<math|x\<in\>B>>Then <math|min<around*|(|A|)>\<leqslant\>min<around*|(|B|)>\<leqslant\>x>
          so that <math|min<around*|(|A|)>\<leqslant\>x>
        </description>

        Hence <math|\<forall\>x\<in\>A<big|cup>B> we have that
        <math|min<around*|(|A|)>\<leqslant\>x> proving that\ 

        <\equation*>
          min<around*|(|A<big|cup>B|)>=min<around*|(|A|)>\<equallim\><rsub|<text|[example:
          <reference|order min({x,y})>]>>min<around*|(|<around*|{|min<around*|(|A|)>,min<around*|(|B|)>|}>|)>
        </equation*>

        <item*|<math|min<around*|(|B|)>\<leqslant\>min<around*|(|A|)>>>Then
        <math|min<around*|(|B|)>\<in\>B\<subseteq\>A<big|cup>B> and
        <math|\<forall\>x\<in\>A<big|cup>B> we have either:

        <\description>
          <item*|<math|x\<in\>A>>Then <math|min<around*|(|B|)>\<leqslant\>min<around*|(|A|)>\<leqslant\>x>
          so that <math|min<around*|(|B|)>\<leqslant\>x>

          <item*|<math|x\<in\>B>>Then <math|min<around*|(|B|)>\<leqslant\>x>
        </description>

        Hence <math|\<forall\>x\<in\>A<big|cup>B> we have that
        <math|min<around*|(|B|)>\<leqslant\>x> proving that\ 

        <\equation*>
          min<around*|(|A<big|cup>B|)>=min<around*|(|B|)>\<equallim\><rsub|<text|[example:
          <reference|order min({x,y})>]>>min<around*|(|<around*|{|min<around*|(|A|)>,min<around*|(|B|)>|}>|)>
        </equation*>
      </description>
    </enumerate>
  ...
  <\definition>
    <label|interval interval>Let <math|<around*|\<langle\>|A,\<leqslant\>|\<rangle\>>>
    be a partial ordered class then if <math|a,b\<in\>A> we define
    ...
    these are the intervals in <math|A>
  </definition>
  ...
  <\theorem>
    <label|interval generalized interval condition>Let
    <math|<around*|\<langle\>|A,\<leqslant\>|\<rangle\>>> be a partial
    ordered class that is conditional complete and <math|I\<subseteq\>A> then
    then\ 

    <\equation*>
      I<text| is a generalized interval >\<Leftrightarrow\><text|
      >\<forall\>x,y\<in\>I<text| we have ><around*|]|x,y|[>\<subseteq\>I
    </equation*>
  </theorem>
  ...
  <\proof>
    ...
    <\description>
      <item*|<math|\<Rightarrow\>>>Let <math|x,y\<in\>I> then if
      ...
      <item*|<math|\<Leftarrow\>>>Let <math|x,y\<in\>I> then if
  ...
  <\theorem>
    <label|interval and inf or sup>Let <math|<around*|\<langle\>|A,\<leqslant\>|\<rangle\>>>
    be a fully ordered class that is conditional complete and
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|>|<cell|<around*|[|a,b|]>>|<cell|a,b\<in\>A<text|
      and >a\<leqslant\>b>>|<row|<cell|>|<cell|<around*|]|a,b|]>>|<cell|a,b\<in\>A<text|
      and >a\<less\>b>>|<row|<cell|>|<cell|<around*|[|a,b|[>>|<cell|a,b\<in\>A<text|
      and >a\<less\>b>>|<row|<cell|>|<cell|<around*|]|a,b|[>>|<cell|a,b\<in\>A<text|
      and >a\<less\>b>>|<row|<cell|>|<cell|<around*|[|a,\<infty\>|[>>|<cell|>>|<row|<cell|>|<cell|<around*|]|a,\<infty\>|[>>|<cell|>>|<row|<cell|>|<cell|<around*|]|-\<infty\>,a|]>>|<cell|>>|<row|<cell|>|<cell|<around*|]|-\<infty\>,a|[>>|<cell|>>|<row|<cell|>|<cell|<around*|]|-\<infty\>,\<infty\>|[>>|<cell|>>>>
    </eqnarray*>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\enumerate>
        ...
        As <math|I> is a generalized interval and
        <math|sup<around*|(|I|)>\<in\>I\<wedge\>inf<around*|(|I|)>\<in\>I >we
        have further that <math|<around*|[|inf<around*|(|I|)>,sup<around*|(|I|)>|]>\<subseteq\>I>
        ...
        <item>Let <math|z\<in\>I> then using the definition of a supremum and
        infinum as upper and lower bound and the fact that
        <math|inf<around*|(|I|)>\<nin\>I> we have that
        <math|inf<around*|(|I|)>\<less\>z\<wedge\>z\<leqslant\>sup<around*|(|I|)>>
        so that
        ...
        Using [theorem: <reference|order sup, inf property>] there exists a
        ...
        Combining this with [eq: <reference|eq 2.21.053>] proves
        ...
        <item>Let <math|z\<in\>I> then using the definition of a supremum and
        infinum as upper and lower bound and the fact that
        <math|sup<around*|(|I|)>\<nin\>I> we have that
        <math|inf<around*|(|I|)>\<leqslant\>z\<wedge\>z\<less\>sup<around*|(|I|)>>
        so that
        ...
        Combining this with [eq: <reference|eq 2.22.053>] proves\ 
        ...
        <item>Let <math|z\<in\>I> then using the definition of a supremum and
        infinum as upper and lower bound and the fact that
        <math|inf<around*|(|I|)>\<nin\>I\<wedge\>sup<around*|(|I|)>\<nin\>I>
        ...
        Using [theorem: <reference|order sup, inf property>] there exists
        ...
        <math|<around*|]|inf<around*|(|I|)>,sup<around*|(|I|)>|[>\<subseteq\>I>.
        Combining this with [eq: <reference|eq 2.23.053>] gives\ 
      ...
      <\enumerate>
        <item>Let <math|z\<in\>I> then using the definition of the infinum as
        a lower bound we have that <math|inf<around*|(|I|)>\<leqslant\>z>
        proving that\ 
        ...
        combining this with [eq: <reference|eq 2.24.053>] proves
        ...
        <item>Let <math|z\<in\>I> then using the definition of the infinum as
        a lower bound and the fact that <math|inf<around*|(|I|)>\<nin\>I> we
        have that <math|inf<around*|(|I|)>\<less\>z> proving that
        ...
        If <math|z\<in\><around*|]|inf<around*|(|I|)>,\<infty\>|[>> then
        <math|inf<around*|(|I|)>\<less\>z>. Using [theorem: <reference|order
        sup, inf property>] there exists a <math|x\<in\>I> such that
        ...
        <math|<around*|]|inf<around*|(|I|)>,\<infty\>|[>\<subseteq\>I> and
        combining this with [eq: <reference|eq 2.25.053>] gives
      ...
      <\enumerate>
        ...
        as a upper bound we have <math|z\<leqslant\>sup<around*|(|I|)>>
        proving that\ 
        ...
        combined with [eq: <reference|eq 2.26.053>] gives\ 
        ...
        <item>Let <math|z\<in\>I> then using the definition of the supremum
        as a upper bound and the fact that <math|sup<around*|(|I|)>\<nin\>I>
        we have that <math|z\<less\>sup<around*|(|I|)>> proving that\ 
        ...
        If <math|z\<in\><around*|]|-\<infty\>,sup<around*|(|I|)>|[>> then
        <math|z\<less\>sup<around*|(|I|)>>. Using [theorem: <reference|order
        sup, inf property>] there exists a <math|y\<in\>I> such that
        ...
        generalized interval and <math|x,y\<in\>I>]. So
        <math|<around*|]|-\<infty\>,sup<around*|(|I|)>|[>\<subseteq\>I> which
        combined with [eq: <reference|eq 2.27.053>] proves\ 
  ...
  <\theorem>
    <label|interval generalized condition (1)>Let
    ...
    <\enumerate>
      <item><math|<around*|[|a,b|]>> is a generalized interval
      ...
      <item><math|<around*|[|a,\<infty\>|[>> is a generalized interval

      <item><math|<around*|]|a,\<infty\>|[>> is a generalized interval

      <item><math|<around*|]|-\<infty\>,a|]>> is a generalized interval

      <item><math|<around*|]|-\<infty\>,a|[>> is a generalized interval

      <item><math|A> is a generalized interval
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <math|z\<in\><around*|[|x,y|]>> we have
      <math|x\<leqslant\>z\<Rightarrowlim\><rsub|a\<leqslant\>x>a\<leqslant\>z>
      proving that <math|z\<in\><around*|[|a,\<infty\>|[>>. Hence
      <math|<around*|[|x,y|]>\<subseteq\><around*|[|a,\<infty\>|[> >from
      ...
      proving that <math|z\<in\><around*|]|-\<infty\>,a|]>>. Hence
      <math|<around*|[|x,y|]>\<subseteq\><around*|]|-\<infty\>,a|]>> from
      which it follows that\ 
      ...
      <item>If <math|x,y\<in\>A> then trivially
      <math|<around*|[|x,y|]>\<subseteq\>A> hence <math|A> is a generalized
      interval.
    </enumerate>
  </proof>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>As <math|<around*|[|a,b|]>=<around*|[|c,d|]>\<neq\>\<varnothing\>>
      it follows from [theorem: <reference|interval condition to be empty>]
      that <math|a\<leqslant\>b> and <math|c\<leqslant\>d> so that
      <math|a,b\<in\><around*|[|a,b|]>=<around*|[|c,d|]>\<Rightarrow\>c\<leqslant\>a\<wedge\>b\<leqslant\>d>
      and <math|c,d\<in\><around*|[|c,d|]>=<around*|[|a,b|]>\<Rightarrow\>a\<leqslant\>c\<wedge\>d\<leqslant\>b>
      proving that <math|a=c\<wedge\>b=d>.

      <item>As <math|<around*|]|a,b|]>=<around*|]|c,d|]>\<neq\>\<varnothing\>>
      it follows from [theorem: <reference|interval condition to be empty>]
      that <math|a\<less\>b\<wedge\>c\<less\>d> hence
      <math|b\<in\><around*|]|a,b|]>\<wedge\>d\<in\><around*|]|c,d|]>>. From
      <math|b\<in\><around*|]|a,b|]>=<around*|]|c,d|]>> we have
      <math|b\<leqslant\>d> and from <math|d\<in\><around*|]|c,d|]>=<around*|]|a,b|]>>
      we have <math|d\<leqslant\>b> hence we have\ 

      <\equation*>
        b=d
      </equation*>

      Assume that <math|a\<less\>c> then as <math|c\<less\>d=b> we have
      <math|c\<in\><around*|]|a,b|]>=<around*|]|c,d|]>> so that
      <math|c\<less\>c> a contradiction, hence we must have\ 

      <\equation>
        <label|eq 3.82.146>c\<leqslant\>a
      </equation>

      Assume that <math|c\<less\>a> then as <math|a\<less\>b=d> we have
      <math|a\<in\><around*|]|c,d|]>=<around*|]|a,b|]>> so that
      <math|a\<less\>a> a contradiction hence we must have <math|a\<leq\>c>
      which combined with [eq: <reference|eq 3.82.146>] proves that\ 
      ...
      <item>As <math|<around*|[|a,b|[>=<around*|[|c,d|[>\<neq\>\<varnothing\>>
      we have by [theorem: <reference|interval condition to be empty>] that
      <math|a\<less\>b\<wedge\>c\<less\>d> so that
      <math|a\<in\><around*|[|a,b|[>\<wedge\>c\<in\><around*|[|c,d|[>>. From
      <math|a\<in\><around*|[|a,b|[>=<around*|[|c,d|[>> it follows that
      <math|c\<leqslant\>a> and from <math|c\<in\><around*|[|c,d|[>=<around*|[|a,b|[>>
      we have <math|a\<leqslant\>c> hence we have\ 

      <\equation*>
        a=c
      </equation*>

      Assume that <math|b\<less\>d> then as <math|c=a\<less\>b> we have
      <math|b\<in\><around*|[|c,d|[>=<around*|[|a,b|[>> so that
      <math|b\<less\>b> a contradiction, hence\ 

      <\equation>
        <label|eq 3.83.146>b\<leqslant\>d
      </equation>

      Assume that <math|d\<less\>b> then as <math|a=c\<less\>d\<less\>b> we
      have <math|d\<in\><around*|[|a,b|[>=<around*|[|c,d|[>> so that
      <math|d\<less\>d> a contradiction, hence <math|d\<leqslant\>b> which
      combined with [eq: <reference|eq 3.83.146>] proves\ 
      ...
      <\equation>
        <label|eq 3.84.146>a\<less\>x\<less\>b\<wedge\>c\<less\>x\<less\>d
      </equation>

      Assume that <math|a\<less\>c> then by [eq: <reference|eq 3.84.146>]
      <math|a\<less\>c\<less\>x\<less\>b> so that
      <math|c\<in\><around*|]|a,b|[>=<around*|]|c,d|[>> leading to the
      contradiction <math|c\<less\>c> hence\ 

      <\equation>
        <label|eq 3.85.146>c\<leqslant\>a
      </equation>

      Assume that <math|c\<less\>a> then by [eq: <reference|eq 3.84.146>]
      <math|c\<less\>a\<less\>x\<less\>d> so that
      <math|a\<in\><around*|]|c,d|[>=<around*|]|a,b|[>> leading to the
      contradiction <math|a\<less\>a> hence <math|a\<leqslant\>c> which
      combined with [eq: <reference|eq 3.85.146>] gives
      ...
      Assume that <math|d\<less\>b> then by \ [eq: <reference|eq 3.84.146>]
      <math|a\<less\>x\<less\>d\<less\>b> so that
      <math|d\<in\><around*|]|a,b|[>=<around*|]|c,d|[>> leading to the
      contradiction <math|d\<less\>d> proving that <math|b\<leqslant\>d>.
      Combining this with [eq: <reference|eq 3.86.146>] results in\ 
...
<\references>
  <\collection>
    ...
    <associate|eq 2.12.001|<tuple|2.20|?>>
    <associate|eq 2.12.002|<tuple|2.12|?>>
    <associate|eq 2.13.001|<tuple|2.21|?>>
    <associate|eq 2.13.002|<tuple|2.13|?>>
    <associate|eq 2.14.001|<tuple|2.30|?>>
    <associate|eq 2.14.009|<tuple|2.18|?>>
    <associate|eq 2.14.141|<tuple|2.14|?>>
    <associate|eq 2.15.013|<tuple|2.19|?>>
    <associate|eq 2.15.141|<tuple|2.15|?>>
    <associate|eq 2.16.003|<tuple|2.34|?>>
    <associate|eq 2.16.005|<tuple|2.22|?>>
    <associate|eq 2.16.141|<tuple|2.16|?>>
    <associate|eq 2.17.002|<tuple|2.35|?>>
    <associate|eq 2.17.004|<tuple|2.31|?>>
    <associate|eq 2.17.006|<tuple|2.23|?>>
    <associate|eq 2.17.141|<tuple|2.17|?>>
    <associate|eq 2.18.002|<tuple|2.36|?>>
    <associate|eq 2.18.006|<tuple|2.24|?>>
    <associate|eq 2.19.002|<tuple|2.37|?>>
    <associate|eq 2.2.001|<tuple|2.4|?>>
    <associate|eq 2.20.002|<tuple|2.38|?>>
    <associate|eq 2.20.053|<tuple|3.75|?>>
    <associate|eq 2.21.002|<tuple|2.39|?>>
    <associate|eq 2.21.017|<tuple|2.27|?>>
    <associate|eq 2.21.053|<tuple|3.76|?>>
    <associate|eq 2.22.017|<tuple|2.28|?>>
    <associate|eq 2.22.053|<tuple|3.77|?>>
    <associate|eq 2.23.053|<tuple|3.78|?>>
    <associate|eq 2.24.053|<tuple|3.79|?>>
    <associate|eq 2.25.004|<tuple|2.41|?>>
    <associate|eq 2.25.053|<tuple|3.80|?>>
    <associate|eq 2.25.141|<tuple|2.25|?>>
    <associate|eq 2.26.004|<tuple|2.42|?>>
    <associate|eq 2.26.053|<tuple|3.81|?>>
    <associate|eq 2.26\<point\>1|<tuple|2.26|?>>
    <associate|eq 2.27.004|<tuple|2.43|?>>
    <associate|eq 2.27.053|<tuple|3.82|?>>
    <associate|eq 2.27.133|<tuple|2.33|?>>
    <associate|eq 2.28.004|<tuple|2.44|?>>
    <associate|eq 2.28.401|<tuple|2.29|?>>
    <associate|eq 2.29.004|<tuple|2.46|?>>
    <associate|eq 2.29.012|<tuple|2.40|?>>
    <associate|eq 2.3.001.2|<tuple|2.3|?>>
    <associate|eq 2.30.004|<tuple|2.47|?>>
    <associate|eq 2.31.004|<tuple|2.48|?>>
    <associate|eq 2.31.010|<tuple|2.45|?>>
    <associate|eq 2.31.400|<tuple|2.32|?>>
    <associate|eq 2.32.004|<tuple|2.49|?>>
    <associate|eq 2.34.005|<tuple|2.50|?>>
    <associate|eq 2.35.005|<tuple|2.51|?>>
    <associate|eq 2.38.006|<tuple|2.52|?>>
    <associate|eq 2.39.006|<tuple|2.53|?>>
    <associate|eq 2.40.006|<tuple|2.55|?>>
    <associate|eq 2.40.007|<tuple|2.54|?>>
    <associate|eq 2.41.006|<tuple|2.56|?>>
    <associate|eq 2.42.006|<tuple|2.57|?>>
    <associate|eq 2.43.006|<tuple|2.59|?>>
    <associate|eq 2.44.006|<tuple|2.60|?>>
    <associate|eq 2.44.007|<tuple|2.58|?>>
    <associate|eq 2.45.006|<tuple|2.61|?>>
    <associate|eq 2.48.007|<tuple|2.65|?>>
    <associate|eq 2.48.008|<tuple|2.62|?>>
    <associate|eq 2.49.007|<tuple|2.66|?>>
    <associate|eq 2.5.001.2|<tuple|2.5|?>>
    <associate|eq 2.50.007|<tuple|2.67|?>>
    <associate|eq 2.51.007|<tuple|2.72|?>>
    <associate|eq 2.51.010|<tuple|2.63|?>>
    <associate|eq 2.57.146|<tuple|2.64|?>>
    <associate|eq 2.59.018|<tuple|2.70|?>>
    <associate|eq 2.59.022|<tuple|2.68|?>>
    <associate|eq 2.6.001|<tuple|2.6|?>>
    <associate|eq 2.60.018|<tuple|2.71|?>>
    <associate|eq 2.60.022|<tuple|2.69|?>>
    ...
    <associate|equivalence relation canical function|<tuple|3.22|?>>
    ...
    <associate|equivalence relation defines a partition (1)|<tuple|3.18|?>>
    <associate|equivalence relation determined by a function|<tuple|3.21|?>>
    <associate|equivalence relation function|<tuple|3.19|?>>
    ...
    <associate|family|<tuple|2.108|?>>
    <associate|family and function composition|<tuple|2.117|?>>
    <associate|family de Morgan|<tuple|2.138|?>>
    <associate|family definition (2)|<tuple|2.114|?>>
    <associate|family definition (3)|<tuple|2.115|?>>
    <associate|family distributivity|<tuple|2.136|?>>
    <associate|family empty family|<tuple|2.111|?>>
    <associate|family empty family condition|<tuple|2.112|?>>
    <associate|family image and preimage|<tuple|2.142|?>>
    <associate|family index set is a product|<tuple|2.116|?>>
    <associate|family intersection (2)|<tuple|2.129|?>>
    <associate|family intersection is a set|<tuple|2.130|?>>
    <associate|family intersection(1)|<tuple|2.128|?>>
    <associate|family product and index transformation|<tuple|2.151|?>>
    <associate|family properties (1)|<tuple|2.133|?>>
    <associate|family properties (2)|<tuple|2.134|?>>
    <associate|family properties (3)|<tuple|2.139|?>>
    <associate|family range|<tuple|2.118|?>>
    <associate|family range (1)|<tuple|2.119|?>>
    <associate|family set|<tuple|2.120|?>>
    <associate|family trivial|<tuple|2.131|?>>
    <associate|family union (1)|<tuple|2.121|?>>
    <associate|family union (2)|<tuple|2.124|?>>
    <associate|family union condition set|<tuple|2.126|?>>
    <associate|family union intersection and empty set|<tuple|2.140|?>>
    <associate|family union intersection and inclusion|<tuple|2.135|?>>
    <associate|family union of a empty set|<tuple|2.127|?>>
    <associate|family union of family of families|<tuple|2.141|?>>
    <associate|family union of family set and surjections|<tuple|2.125|?>>
    <associate|family union of union of two families|<tuple|2.137|?>>
    <associate|family union{A,B}|<tuple|2.132|?>>
    <associate|family {x}xeA|<tuple|2.113|?>>
    <associate|function|<tuple|2.24|?>>
    <associate|function A^empty is empty|<tuple|2.33|?>>
    <associate|function B^A|<tuple|2.31|?>>
    <associate|function B^A and inclusion|<tuple|2.35|?>>
    <associate|function P(A)=2^A|<tuple|2.79|?>>
    <associate|function alternative for composition|<tuple|2.43|?>>
    <associate|function and power|<tuple|2.78|?>>
    <associate|function between {0,1} and {A,B}|<tuple|2.27|?>>
    <associate|function bijection and inverse|<tuple|2.73|?>>
    ...
    <associate|function bijection removing element|<tuple|2.97|?>>
    <associate|function characteristics function|<tuple|2.47|?>>
    <associate|function combining bijections|<tuple|2.86|?>>
    <associate|function combining functions (1)|<tuple|2.83|?>>
    <associate|function combining functions (2)|<tuple|2.85|?>>
    <associate|function composition and restriction|<tuple|2.94|?>>
    <associate|function composition injectivity, surjectivity and
    bijectivity|<tuple|2.76|?>>
    <associate|function composition injectivity, surjectivity and bijectivity
    (1)|<tuple|2.77|?>>
    <associate|function composition of Id function|<tuple|2.49|?>>
    ...
    <associate|function constant function|<tuple|2.46|?>>
    <associate|function empty function|<tuple|2.45|?>>
    <associate|function empty function bijection|<tuple|2.64|?>>
    <associate|function equality (1)|<tuple|2.39|?>>
    <associate|function equality (2)|<tuple|2.42|?>>
    <associate|function extend target|<tuple|2.34|?>>
    <associate|function extending funtion domain|<tuple|2.87|?>>
    <associate|function f(x)|<tuple|2.40|?>>
    <associate|function function and intersection and union|<tuple|2.101|?>>
    ...
    <associate|function indexed set|<tuple|2.105|?>>
    <associate|function indexed set example|<tuple|2.107|?>>
    <associate|function indexed set unique|<tuple|2.106|?>>
    ...
    <associate|function inverse and restriction|<tuple|2.93|?>>
    <associate|function inverse function and bijection|<tuple|2.98|?>>
    <associate|function inverse function and f(x)|<tuple|2.71|?>>
    <associate|function inverse image preimage|<tuple|2.69|?>>
    <associate|function inverse of Id|<tuple|2.75|?>>
    ...
    <associate|function properties (1)|<tuple|2.100|?>>
    <associate|function range restriction|<tuple|2.38|?>>
    <associate|function restricted function properties|<tuple|2.91|?>>
    <associate|function restriction and composition|<tuple|2.81|?>>
    <associate|function restriction and composition (1)|<tuple|2.82|?>>
    <associate|function restriction and domain|<tuple|2.92|?>>
    <associate|function restriction of a function|<tuple|2.96|?>>
    <associate|function restriction of a graph|<tuple|2.80|?>>
    <associate|function simple definition|<tuple|2.102|?>>
    <associate|function simple definition notation|<tuple|2.103|?>>
    <associate|function stitching of functions|<tuple|2.89|?>>
    ...
    <associate|partial function injectivity and surjectivity|<tuple|2.51|?>>
    <associate|partial function inverse graph|<tuple|2.57|?>>
    <associate|partial function inverse if injective|<tuple|2.58|?>>
    ...
    <associate|product|<tuple|2.143|?>>
    <associate|product and intersection|<tuple|2.148|?>>
    <associate|product and power|<tuple|2.150|?>>
    <associate|product extension|<tuple|2.153|?>>
    <associate|product inclusion|<tuple|2.147|?>>
    <associate|product intersection of a product|<tuple|2.149|?>>
    <associate|product of a empty set is empty|<tuple|2.144|?>>
    <associate|product of family with one element|<tuple|2.145|?>>
    <associate|product of family with two classes|<tuple|2.146|?>>
    <associate|product product is not empty|<tuple|3.110|?>>
    <associate|product projection function|<tuple|2.154|?>>
    <associate|product projection is surjective|<tuple|3.109|?>>
    <associate|product sub-product|<tuple|2.152|?>>
