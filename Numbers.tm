...
<\body>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|x\<cdot\>z\<leqslant\>y\<cdot\>z>
  ...
  <\theorem>
    <label|complex sup(-S),inf(-S)>Let <math|\<varnothing\>\<neq\>S\<subseteq\>\<bbb-R\><rsub|\<bbb-C\>>>
    then for <math|-S=<around*|{|-s\|s\<in\>S|}>> we have\ 
  ...
  <\proof>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|s\<in\>-S>|<cell|\<Leftrightarrow\>>|<cell|\<exists\>s<rprime|'>\<in\>S<text|
      such that >s=-s<rprime|'>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|\<exists\>s<rprime|'>\<in\>S<text|
      such that >-s=s<rprime|'>>>|<row|<cell|>|<cell|\<Leftrightarrow\>>|<cell|-s\<in\>S>>>>
    </eqnarray*>
    ...
    <\enumerate>
      <item>Let <math|s\<in\>-S> then <math|-s\<in\>S> so that
      <math|-s\<leqslant\>sup<around*|(|S|)>\<Rightarrow\>-sup<around*|(|S|)>\<leqslant\>s>.
      So <math|-S> is bounded below by <math|-sup<around*|(|S|)>>, as
      <math|\<bbb-R\><rsub|\<bbb-C\>>> is conditional complete [see theorem:
      <reference|complex RC is conditional complete>] we have that

      <\equation>
        <label|eq 10.22.155>inf<around*|(|-S|)><text| exist and
        >-sup<around*|(|S|)>\<leqslant\>inf<around*|(|-S|)>
      </equation>

      Assume that <math|-sup<around*|(|S|)>\<less\>inf<around*|(|-S|)>> then
      <math|-inf<around*|(|-S|)>\<less\>sup<around*|(|S|)>> so that by the
      definition of the supremum there exist a <math|s\<in\>S> such that
      <math|-inf<around*|(|-S|)>\<less\>s\<Rightarrow\>-s\<less\>inf<around*|(|-S|)>>
      which, as <math|-s\<in\>-S\<Rightarrow\>inf<around*|(|-S|)>\<leqslant\>-s>,
      ...
      <item>Let <math|s\<in\>-S> then <math|-s\<in\>S> so that
      <math|inf<around*|(|S|)>\<leqslant\>-s\<Rightarrow\>s\<leqslant\>-inf<around*|(|S|)>>.
      So <math|-S> is bounded above by <math|-inf<around*|(|S|)>>, as
      <math|\<bbb-R\><rsub|\<bbb-C\>>> is conditional complete [see theorem:
      <reference|complex RC is conditional complete>] we have that
      ...
      Assume that <math|sup<around*|(|-S|)>\<less\>-inf<around*|(|S|)>> then
      <math|inf<around*|(|S|)>\<less\>-sup<around*|(|-S|)>> so that by the
      definition of the infinum there exist a <math|s\<in\>S> such that
      <math|s\<less\>-sup<around*|(|-S|)>\<Rightarrow\>sup<around*|(|-S|)>\<less\>-s>
  ...
  <\theorem>
    <label|complex sup(a.x) inf(a.x)>Let <math|\<varnothing\>\<neq\>S\<subseteq\>\<bbb-R\><rsub|\<bbb-C\>>>
    and <math|\<alpha\>\<in\>\<bbb-R\><rsub|\<bbb-C\>>> with
    <math|0\<leqslant\>\<alpha\>> then we have for
    <math|\<alpha\>\<cdot\>S=<around*|{|\<alpha\>\<cdot\>s\|s\<in\>S|}>> that
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|inf<around*|(|S+T|)>=inf<around*|(|S|)>+inf<around*|(|T|)>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      conditional complete>] proves that\ 
      ...
      is totally ordered we have by [theorem: <reference|order sup, inf
  ...
  <\theorem>
    ...
    <\enumerate>
      <item>If <math|max<around*|(|S|)>,max<around*|(|T|)>> exists then
      <math|max<around*|(|S+T|)>> exist and
      <math|max<around*|(|S+T|)>=max<around*|(|S|)>+max<around*|(|T|)>>

      <item>If <math|min<around*|(|S|)>,min<around*|(|T|)>> exists then
      <math|min<around*|(|S+T|)>> exist and
      <math|min<around*|(|S+T|)>=min<around*|(|S|)>+min<around*|(|T|)>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|max<around*|(|S|)>>, <math|max<around*|(|T|)>> exist we
      have\ 

      <\equation*>
        max<around*|(|S|)>\<in\>S\<wedge\>max<around*|(|T|)>\<in\>S\<wedge\>\<forall\>s\<in\>S<text|
        >s\<leqslant\>max<around*|(|S|)>\<wedge\>\<forall\>t\<in\>T<text|
        >t\<leqslant\>max<around*|(|T|)>
      </equation*>

      As <math|max<around*|(|S|)>\<in\>S> and
      <math|max<around*|(|T|)>\<in\>T> it follows by definition that\ 

      <\equation>
        <label|eq 10.26.146>max<around*|(|S|)>+max<around*|(|T|)>\<in\>S+T
      </equation>

      Further if <math|x\<in\>S+T> then there exists a <math|s\<in\>S> and a
      <math|t\<in\>T> such that <math|x=s+t>, hence, as
      <math|s\<leqslant\>max<around*|(|S|)>\<wedge\>t\<leqslant\>max<around*|(|T|)>>,
      we have <math|x=s+t\<leqslant\>max<around*|(|S|)>+max<around*|(|T|)>>.
      This proves that\ 

      <\equation>
        <label|eq 10.27.146>\<forall\>x\<in\>S+T<text| we have
        >x\<leqslant\>max<around*|(|S|)>+max<around*|(|T|)>
      </equation>

      Finally using the definition of the maximum together with [eqs:
      <reference|eq 10.26.146>, <reference|eq 10.27.146>] we have that\ 

      <\equation*>
        max<around*|(|S+T|)><text| exists and
        >max<around*|(|S+T|)>=max<around*|(|S|)>+max<around*|(|T|)>
      </equation*>

      <item>As <math|min<around*|(|S|)>>, <math|min<around*|(|T|)>> exist we
      have\ 

      <\equation*>
        min<around*|(|S|)>\<in\>S\<wedge\>min<around*|(|T|)>\<in\>S\<wedge\>\<forall\>s\<in\>S<text|
        >min<around*|(|S|)>\<leqslant\>s\<wedge\>\<forall\>t\<in\>T<text|
        >min<around*|(|T|)>\<leqslant\>t
      </equation*>

      As <math|min<around*|(|S|)>\<in\>S> and
      <math|min<around*|(|T|)>\<in\>T> it follows by definition that\ 

      <\equation>
        <label|eq 10.28.146>min<around*|(|S|)>+min<around*|(|T|)>\<in\>S+T
      </equation>

      Further if <math|x\<in\>S+T> then there exists a <math|s\<in\>S> and a
      <math|t\<in\>T> such that <math|x=s+t>, hence, as
      <math|min<around*|(|S|)>\<leqslant\>s\<wedge\>min<around*|(|T|)>\<leqslant\>t>,
      we have <math|min<around*|(|S|)>+min<around*|(|T|)>\<leqslant\>s+t=x>.
      This proves that\ 

      <\equation>
        <label|eq 10.29.146>\<forall\>x\<in\>S+T<text| we have
        >min<around*|(|S|)>+min<around*|(|T|)>\<leqslant\>s+t
      </equation>

      Finally using the definition of the minimum together with [eqs:
      <reference|eq 10.28.146>, <reference|eq 10.29.146>] we have that\ 

      <\equation*>
        min<around*|(|S+T|)><text| exists and
        >min<around*|(|S+T|)>=min<around*|(|S|)>+min<around*|(|T|)>
      </equation*>
    </enumerate>
  </proof>

  <\corollary>
    <label|complex max(S+s), min(S+s)>Let
    <math|\<varnothing\>\<neq\>S\<subseteq\>\<bbb-R\><rsub|\<bbb-C\>>> and
    <math|\<alpha\>\<in\>\<bbb-R\><rsub|\<bbb-C\>>> then we have\ 

    <\enumerate>
      <item>If <math|max<around*|(|S|)>> exist then
      <math|max<around*|(|S+\<alpha\>|)>> exist and
      <math|max<around*|(|S+\<alpha\>|)>=max<around*|(|S|)>+\<alpha\>>

      <item>If <math|min<around*|(|S|)>> exist then
      <math|min<around*|(|S+\<alpha\>|)>> exist and
      <math|min<around*|(|S+\<alpha\>|)>=min<around*|(|S|)>+\<alpha\>>
    </enumerate>
  </corollary>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>Define <math|T=<around*|{|\<alpha\>|}>> then
      <math|S+T=S+\<alpha\>> and <math|max<around*|(|T|)>> exist and
      <math|max<around*|(|T|)>=\<alpha\>>. Hence by ]theorem:
      <reference|complex max(S+T),min(S+T)>]
      <math|max<around*|(|S+\<alpha\>|)>=max<around*|(|S+T|)>> exist and

      <\equation*>
        max<around*|(|S+\<alpha\>|)>=max<around*|(|S|)>+max<around*|(|<around*|{|\<alpha\>|}>|)>=max<around*|(|S|)>+\<alpha\>
      </equation*>

      <item>Define <math|T=<around*|{|\<alpha\>|}>> then
      <math|S+T=S+\<alpha\>> and <math|min<around*|(|T|)>> exist and
      <math|min<around*|(|T|)>=\<alpha\>>. Hence by ]theorem:
      <reference|complex max(S+T),min(S+T)>]
      <math|min<around*|(|S+\<alpha\>|)>=min<around*|(|S+T|)>> exist and

      <\equation*>
        min<around*|(|S+\<alpha\>|)>=min<around*|(|S|)>+min<around*|(|<around*|{|\<alpha\>|}>|)>=min<around*|(|S|)>+\<alpha\>
      </equation*>
    </enumerate>
  </proof>

  <\theorem>
    <label|complex max(a.x) 0\<less\>=a>Let
    <math|\<varnothing\>\<neq\>S\<subseteq\>\<bbb-R\>> and
    <math|\<alpha\>\<in\>\<bbb-R\>> such that <math|0\<leqslant\>\<alpha\>>
    then for <math|\<alpha\>\<cdot\>S=<around*|{|\<alpha\>\<cdot\>x\|x\<in\>S|}>>
    we have:

    <\enumerate>
      <item><math|max<around*|(|\<alpha\>\<cdot\>S|)>=\<alpha\>\<cdot\>max<around*|(|S|)>>

      <item><math|min<around*|(|\<alpha\>\<cdot\>S|)>=\<alpha\>\<cdot\>min<around*|(|S|)>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>First as <math|max<around*|(|S|)>\<in\>S> we have that
      <math|\<alpha\>\<cdot\>max<around*|(|S|)>\<in\>\<alpha\>\<cdot\>S>. If
      <math|x\<in\>\<alpha\>\<cdot\>S> then there exist a <math|s\<in\>S>
      such that <math|x=\<alpha\>\<cdot\>s>, as
      <math|s\<leqslant\>max<around*|(|S|)>> and
      <math|0\<leqslant\>\<alpha\>> we have by [theorem: <reference|complex
      RC order properties>] <math|>that <math|x=\<alpha\>\<cdot\>s\<leqslant\>\<alpha\>\<cdot\>max<around*|(|S|)>>
      hence <math|max<around*|(|\<alpha\>\<cdot\>S|)>=\<alpha\>\<cdot\>max<around*|(|S|)>>.

      <item>First as <math|min<around*|(|S|)>\<in\>S> we have that
      <math|\<alpha\>\<cdot\>min<around*|(|S|)>\<in\>\<alpha\>\<cdot\>S>. If
      <math|x\<in\>\<alpha\>\<cdot\>S> then there exist a <math|s\<in\>S>
      such that <math|x=\<alpha\>\<cdot\>s>, as
      <math|min<around*|(|S|)>\<leqslant\>s> and
      <math|0\<leqslant\>\<alpha\>> we have by [theorem: <reference|complex
      RC order properties>] <math|>that <math|\<alpha\>\<cdot\>min<around*|(|S|)>\<leqslant\>\<alpha\>\<cdot\>s=x>
      hence <math|min<around*|(|\<alpha\>\<cdot\>S|)>=\<alpha\>\<cdot\>min<around*|(|S|)>>.
    </enumerate>
  </proof>
  ...
  <\corollary>
    ...
    <\enumerate>
      ...
      <item>Let <math|b\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>> then if
      <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>>
      with <math|\<varepsilon\>\<less\>b> we have that
      <math|x\<leqslant\>y+\<varepsilon\>> then <math|x\<leqslant\>y>

      <item>Let <math|a\<in\>\<bbb-R\><rsup|+><rsub|0,\<bbb-C\>>>,
      <math|b\<in\>\<bbb-R\><rsup|+><rsub|0,\<bbb-C\>>> then if
      <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>>
      with <math|\<varepsilon\>\<less\>b> we have that
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <item>Let <math|\<varepsilon\>\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>>
      then we have either:\ 

      <\description>
        <item*|<math|b\<leqslant\>\<varepsilon\>>>Then as <math|0\<less\>b>
        it follow that \ <math|0\<less\><frac|b|2>\<less\>b\<leqslant\>\<varepsilon\>>
        hence we have by the hypothesis that <math|x\<leqslant\>y+<frac|b|2>>
        so that <math|x\<leqslant\>y+\<varepsilon\>>.

        <item*|<math|\<varepsilon\>\<less\>b>>Then by the hypothesis
        <math|x\<leqslant\>y+\<varepsilon\>>
      </description>

      So we have <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>>
      that <math|x\<leqslant\>u+\<varepsilon\>> which by (2) proves that
      <math|x\<leqslant\>y>
      ...
      <\description>
        <item*|<math|b\<leqslant\>\<varepsilon\>>>Then as <math|0\<less\>b>
        it follows that \ <math|0\<less\><frac|b|2>\<less\>b\<leqslant\>\<varepsilon\>>
        hence we have by the hypothesis that
        <math|x\<leqslant\>y+<frac|b|2>\<cdot\>a> so that
        <math|x\<leqslant\>y+\<varepsilon\>\<cdot\>a>.
      ...
      So we have <math|\<forall\>\<varepsilon\>\<in\>\<bbb-R\><rsup|+><rsub|\<bbb-C\>>>
      that <math|x\<leqslant\>u+\<varepsilon\>\<cdot\>a> which by (3) proves
      that <math|x\<leqslant\>y>
  ...
  <\theorem>
    <label|complex 0\<less\>=x\<less\>=z then x^2\<less\>=y^2>Let
    <math|x,y\<in\>\<bbb-R\><rsub|\<bbb-C\>>> then we have
    ...
    <\enumerate>
      ...
      <item>If <math|0\<leqslant\>x\<leqslant\>y> then
      <math|x<rsup|2>\<leqslant\>y<rsup|2>>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item>As <math|0\<leqslant\>x\<less\>y> we have <math|0\<less\>y>. For
      <math|x> we have as <math|0\<leqslant\>x> either

      <\description>
        <item*|<math|x=0>>Then by [theorem: <reference|complex RC order
        properties>] <math|0=0\<cdot\>y\<less\>y\<cdot\>y=y<rsup|2>>. Hence
        <math|x<rsup|2>=0\<cdot\>0=0\<less\>y<rsup|2>>.\ 

        <item*|<math|0\<less\>x>>Then multiplying both sides of
        <math|x\<less\>y> by <math|x> we have by [theorem: <reference|complex
        RC order properties>] that <math|x<rsup|2>=x\<cdot\>x\<less\>y\<cdot\>x>.
        Further multiplying both sides of <math|x\<less\>y> by <math|y> we
        have by [theorem: <reference|complex RC order properties>] that
        <math|x\<cdot\>y\<less\>y\<cdot\>y=y<rsup|2>>, Hence
        <math|x<rsup|2>\<less\>y\<cdot\>x\<less\>y<rsup|2>>.
      </description>

      <item>For <math|x,y> we have as <math|0\<leqslant\>x\<leqslant\>y>
      either\ 

      <\description>
        <item*|<math|x=y>>Then <math|x<rsup|2>=x\<cdot\>x=y\<cdot\>y=y<rsup|2>>
        hence <math|x<rsup|2>\<leqslant\>y<rsup|2>>.

        <item*|<math|x\<less\>y>>Then by (1) we have
        <math|x<rsup|2>\<less\>y<rsup|2>> hence
        <math|x<rsup|2>\<leqslant\>y<rsup|2>>.
      </description>
    </enumerate>
  </proof>
  ...
  <\theorem>
    <label|complex (x^n)^m>If <math|n,m\<in\>\<bbb-N\><rsub|\<bbb-C\>>> then
    <math|\<forall\>x\<in\>\<bbb-C\>> we have
    <math|<around*|(|x<rsup|n>|)><rsup|m>=x<rsup|n\<cdot\>m>>
  </theorem>

  <\proof>
    This is proved by induction, let \ <math|S<rsub|n,x>=<around*|{|m\<in\>\<bbb-N\>\|<around*|(|x<rsup|n>|)><rsup|m>=x<rsup|n\<cdot\>m>|}>>
    then we have:

    <\description>
      <item*|<math|1\<in\>S<rsub|n,x>>>As
      <math|<around*|(|x<rsup|n>|)><rsup|1>=x<rsup|n>=x<rsup|n\<cdot\>1>> we
      have <math|1\<in\>S>.

      <item*|<math|m\<in\>S<rsub|n,x>\<Rightarrow\>m+1\<in\>S<rsub|n,x>>>We
      have

      <\equation*>
        <around*|(|x<rsup|n>|)><rsup|m+1>=<around*|(|x<rsup|n>|)><rsup|m>\<cdot\>x<rsup|n>\<equallim\><rsub|m\<in\>S>x<rsup|n\<cdot\>m>\<cdot\>x<rsup|n>\<equallim\><rsub|<text|[theorem:
        <reference|complex x^(m+n)=x^n.x^m>]>>x<rsup|n\<cdot\>m+n>=x<rsup|n\<cdot\><around*|(|m+1|)>>
      </equation*>
  ...
  <\corollary>
    <label|complex 1\<less\>x then a\<less\>x^n>Let
    <math|x,y\<in\>\<bbb-R\><rsub|\<bbb-C\>>> with <math|1\<less\>x> then
    there exist a <math|n\<in\>\<bbb-N\><rsub|\<bbb-C\>>> such that
    <math|y\<less\>x<rsup|n>>
  </corollary>

  <\proof>
    Using [theorem: <reference|complex Archimedean property consequence (1)>]
    there exist a <math|m\<in\>\<bbb-N\><rsub|\<bbb-C\>>> such that
    <math|y\<less\>m> and by the previous theorem [theorem:
    <reference|complex x^n\<gtr\>n if x\<gtr\>1 (R)>] there exist a
    <math|n\<in\>\<bbb-N\><rsub|0,\<bbb-C\>>> such that
    <math|m\<less\>x<rsup|n>>, hence <math|y\<less\>x<rsup|n>>.
  </proof>
  ...
  <\theorem>
    ...
    <\note>
      As <math|0\<less\><frac|1|2>\<less\>1> it follows from the above that
      <math|\<exists\>N\<in\>\<bbb-N\><rsub|\<bbb-C\>>> such that
      <math|\<forall\>n\<in\>\<bbb-N\><rsub|\<bbb-C\>>> with
      <math|N\<leqslant\>n> we have\ 

      <\equation*>
        0\<less\><frac|1|2<rsup|n>>\<less\>\<varepsilon\>
      </equation*>
    </note>
  </theorem>
  ...
  <\theorem>
    ...
    <\enumerate>
      ...
      <math|Re<around*|(|\<alpha\>\<cdot\>z|)>=\<alpha\>\<cdot\>Re<around*|(|z|)>>.
  ...
  <\proof>
    ...
    <\enumerate>
      ...
      <\eqnarray*>
        <tformat|<table|<row|<cell|Re<around*|(|\<alpha\>\<cdot\>z|)>>|<cell|\<equallim\><rsub|<around*|(|1|)>>>|<cell|Re<around*|(|Re<around*|(|\<alpha\>|)>\<cdot\><around*|(|Re<around*|(|z|)>+i\<cdot\>Img<around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|Re<around*|(|Re<around*|(|\<alpha\>|)>\<cdot\>Re<around*|(|z|)>+i\<cdot\><around*|(|Re<around*|(|\<alpha\>|)>\<cdot\>Img<around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|Re<around*|(|\<alpha\>|)>\<cdot\>Re<around*|(|z|)>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|(|1|)>>>|<cell|\<alpha\>\<cdot\>Re<around*|(|z|)>>>>>
      </eqnarray*>

      <item>\ 

      <\eqnarray*>
        <tformat|<table|<row|<cell|Img<around*|(|\<alpha\>\<cdot\>z|)>>|<cell|\<equallim\><rsub|<around*|(|1|)>>>|<cell|Img<around*|(|Re<around*|(|\<alpha\>|)>\<cdot\><around*|(|Re<around*|(|z|)>+i\<cdot\>Img<around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|Img<around*|(|Re<around*|(|\<alpha\>|)>\<cdot\>Re<around*|(|z|)>+i\<cdot\><around*|(|Re<around*|(|\<alpha\>|)>\<cdot\>Img<around*|(|z|)>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|Re<around*|(|\<alpha\>|)>\<cdot\>Re<around*|(|z|)>>>|<row|<cell|>|<cell|=>|<cell|\<alpha\>\<cdot\>Re<around*|(|z|)>>>>>
      </eqnarray*>
    </enumerate>
  ...
  <\theorem>
    <label|complex power of i>For <math|i> we have\ 

    <\enumerate>
      <item><math|i<rsup|2>=-1>

      <item><math|\<forall\>n\<in\>\<bbb-N\><rsub|0>> we have\ 

      <\enumerate>
        <item><math|i<rsup|4\<cdot\>n>=1>

        <item><math|i<rsup|4\<cdot\>n+1>=i>

        <item><math|i<rsup|4\<cdot\>n+2>=-1>

        <item><math|i<rsup|4\<cdot\>n+3>=-i>
      </enumerate>
    </enumerate>
  </theorem>
  ...
  <\proof>
    ...
    <\enumerate>
      <item><math|i<rsup|2>=i\<cdot\>i\<equallim\><rsub|<text|[theorem:
      <reference|complex notation (0)>]>>-1>

      <item>For <math|n\<in\>\<bbb-N\>> we have:

      <\enumerate>
        <item>We use induction to prove this, so let
        <math|S=<around*|{|n\<in\>\<bbb-N\>\|i<rsup|4\<cdot\>n>=1|}>> then we
        have\ 

        <\description>
          <item*|<math|0\<in\>S>>As <math|i<rsup|4\<cdot\>0>=i<rsup|0>=1> we
          have that <math|1\<in\>S>.

          <item*|<math|n\<in\>S\<Rightarrow\>n+1\<in\>S>>We have\ 

          <\eqnarray*>
            <tformat|<table|<row|<cell|i<rsup|4\<cdot\><around*|(|n+1|)>>>|<cell|=>|<cell|i<rsup|4\<cdot\>n+4>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[theorem:
            <reference|complex x^(m+n)=x^n.x^m>]>>>|<cell|i<rsup|4\<cdot\>n>\<cdot\>i<rsup|4>>>|<row|<cell|>|<cell|\<equallim\><rsub|n\<in\>S>>|<cell|1\<cdot\>i<rsup|4>>>|<row|<cell|>|<cell|=>|<cell|i<rsup|2+2>>>|<row|<cell|>|<cell|\<equallim\><rsub|<text|[theorem:
            <reference|complex x^(m+n)=x^n.x^m>]>>>|<cell|i<rsup|2>\<cdot\>i<rsup|2>>>|<row|<cell|>|<cell|\<equallim\><rsub|<around*|(|1|)>>>|<cell|<around*|(|-1|)>\<cdot\><around*|(|-1|)>>>|<row|<cell|>|<cell|=>|<cell|1>>>>
          </eqnarray*>

          proving that <math|n\<in\>S>.
        </description>

        <item><math|i<rsup|4\<cdot\>n+1>\<equallim\><rsub|<text|[theorem:
        <reference|complex x^(m+n)=x^n.x^m>]>>i<rsup|4\<cdot\>n>\<cdot\>i\<equallim\><rsub|<around*|(|2.a|)>>i>

        <item><math|i<rsup|4\<cdot\>n+2>\<equallim\><rsub|<text|[theorem:
        <reference|complex x^(m+n)=x^n.x^m>]>>i<rsup|4\<cdot\>n>\<cdot\>i<rsup|2>\<equallim\><rsub|<around*|(|2\<cdot\>a|)>>i<rsup|2>\<equallim\><rsub|<around*|(|1|)>>-1>

        <item><math|i<rsup|4\<cdot\>n+3>\<equallim\><rsub|<text|[theorem:
        <reference|complex x^(m+n)=x^n.x^m>]>>i<rsup|4\<cdot\>n>\<cdot\>i<rsup|3>\<equallim\><rsub|<around*|(|2\<cdot\>a|)>>i<rsup|3>\<equallim\><rsub|<text|[theorem:
        <reference|complex x^(m+n)=x^n.x^m>]>>i<rsup|2>\<cdot\>i\<equallim\><rsub|<around*|(|2|)>><around*|(|-1|)>\<cdot\>i=-i>
      </enumerate>
    </enumerate>
...
<\references>
  <\collection>
    ...
    <associate|complex (x^n)^m|<tuple|10.53|?>>
    <associate|complex (x^n-1)\<gtr\>=n.(x-1)|<tuple|10.59|?>>
    <associate|complex 0\<less\>1|<tuple|10.10|?>>
    <associate|complex 0\<less\>=x\<less\>=z then
    x^2\<less\>=y^2|<tuple|10.50|?>>
    <associate|complex 0\<less\>x^n\<less\>e|<tuple|10.64|?>>
    <associate|complex 1\<less\>x then a\<less\>x^n|<tuple|10.61|?>>
    ...
    <associate|complex a\<less\>2^n|<tuple|10.58|?>>
    <associate|complex cardinality|<tuple|10.89|?>>
    <associate|complex cardinality adding element|<tuple|10.93|?>>
    <associate|complex cardinality alternative|<tuple|10.90|?>>
    <associate|complex cardinality and finite family|<tuple|10.96|?>>
    <associate|complex cardinality equality and subset|<tuple|10.95|?>>
    <associate|complex cardinality properties|<tuple|10.92|?>>
    <associate|complex cardinality removing a element|<tuple|10.94|?>>
    <associate|complex conjugate|<tuple|10.82|?>>
    <associate|complex conjugate properties|<tuple|10.83|?>>
    ...
    <associate|complex finite lemma|<tuple|10.86|?>>
    <associate|complex finite set condition|<tuple|10.87|?>>
    <associate|complex finite set condition (1)|<tuple|10.88|?>>
    <associate|complex finite subset|<tuple|10.91|?>>
    <associate|complex i^2=-1|<tuple|10.76|?>>
    ...
    <associate|complex max(S+T),min(S+T)|<tuple|10.25|?>>
    <associate|complex max(S+s), min(S+s)|<tuple|10.26|?>>
    <associate|complex max(a.x) 0\<less\>=a|<tuple|10.27|?>>
    <associate|complex n\<less\>2^n|<tuple|10.57|?>>
    <associate|complex n\<less\>m and 0\<less\>x\<less\>1 then
    x^n\<less\>x^m|<tuple|10.62|?>>
    <associate|complex n\<less\>m and 1\<less\>=x then
    x^n\<less\>x^m|<tuple|10.63|?>>
    <associate|complex norm|<tuple|10.84|?>>
    <associate|complex norm properties|<tuple|10.85|?>>
    <associate|complex notation|<tuple|10.3|?>>
    <associate|complex notation (0)|<tuple|10.77|?>>
    <associate|complex numbers|<tuple|10.1|?>>
    <associate|complex order isomorphisms|<tuple|10.9|?>>
    <associate|complex power|<tuple|10.48|?>>
    <associate|complex power and inequality|<tuple|10.56|?>>
    <associate|complex power is internal|<tuple|10.51|?>>
    <associate|complex power of i|<tuple|10.81|?>>
    <associate|complex power of inverse|<tuple|10.54|?>>
    <associate|complex power properties|<tuple|10.55|?>>
    <associate|complex rational numbers specification|<tuple|10.6|?>>
    <associate|complex real imaginair|<tuple|10.79|?>>
    <associate|complex real. imaginair properties|<tuple|10.80|?>>
    ...
    <associate|complex root is strictly increasing|<tuple|10.71|?>>
    <associate|complex sqrt x\<less\>sqrt x^2|<tuple|10.73|?>>
    <associate|complex sqrt(0) and sqrt(1)|<tuple|10.69|?>>
    <associate|complex square operator is a bijection|<tuple|10.66|?>>
    <associate|complex square root|<tuple|10.67|?>>
    <associate|complex square root norm|<tuple|10.75|?>>
    <associate|complex square root of 2 is irational|<tuple|10.70|?>>
    <associate|complex square root of product|<tuple|10.74|?>>
    <associate|complex square root properties (1)|<tuple|10.72|?>>
    ...
    <associate|complex sup(a.x) inf(a.x)|<tuple|10.22|?>>
    <associate|complex x\<less\>x+1 and x-1\<less\>x|<tuple|10.15|?>>
    <associate|complex x\<less\>y=\<gtr\>x+1\<less\>=y|<tuple|10.28|?>>
    <associate|complex x^(m+n)=x^n.x^m|<tuple|10.52|?>>
    <associate|complex x^0,z^1,z^2|<tuple|10.49|?>>
    <associate|complex x^n\<gtr\>n if x\<gtr\>1 (R)|<tuple|10.60|?>>
    <associate|complex {n,..,m}|<tuple|10.34|?>>
    ...
    <associate|eq 10.18.049|<tuple|10.43|?>>
    <associate|eq 10.18.052.1|<tuple|10.18|?>>
    <associate|eq 10.19.049|<tuple|10.44|?>>
    <associate|eq 10.19.050|<tuple|10.26|?>>
    <associate|eq 10.19.052.1|<tuple|10.19|?>>
    <associate|eq 10.2.048|<tuple|10.2|?>>
    <associate|eq 10.20.049|<tuple|10.45|?>>
    <associate|eq 10.20.050|<tuple|10.27|?>>
    <associate|eq 10.21.049|<tuple|10.46|?>>
    ...
    <associate|eq 10.25.050|<tuple|10.36|?>>
    <associate|eq 10.26.049|<tuple|10.50|?>>
    <associate|eq 10.26.050|<tuple|10.37|?>>
    <associate|eq 10.26.146|<tuple|10.30|?>>
    <associate|eq 10.27.049|<tuple|10.51|?>>
    <associate|eq 10.27.050|<tuple|10.38|?>>
    <associate|eq 10.27.146|<tuple|10.31|?>>
    <associate|eq 10.28.050|<tuple|10.39|?>>
    <associate|eq 10.28.146|<tuple|10.32|?>>
    <associate|eq 10.29.050|<tuple|10.40|?>>
    <associate|eq 10.29.146|<tuple|10.33|?>>
    <associate|eq 10.3.048|<tuple|10.3|?>>
    <associate|eq 10.30.050|<tuple|10.41|?>>
    <associate|eq 10.31.050|<tuple|10.42|?>>
    <associate|eq 10.4.048|<tuple|10.4|?>>
    <associate|eq 10.42.050|<tuple|10.54|?>>
    <associate|eq 10.43.050|<tuple|10.55|?>>
    <associate|eq 10.44.050|<tuple|10.56|?>>
    <associate|eq 10.44.053|<tuple|10.52|?>>
    <associate|eq 10.45.050|<tuple|10.57|?>>
    <associate|eq 10.45.053|<tuple|10.53|?>>
    <associate|eq 10.46.050|<tuple|10.58|?>>
    <associate|eq 10.47.050|<tuple|10.59|?>>
    <associate|eq 10.48|<tuple|10.60|?>>
    <associate|eq 10.49.050|<tuple|10.61|?>>
    <associate|eq 10.5.048|<tuple|10.5|?>>
    <associate|eq 10.50.050|<tuple|10.62|?>>
    <associate|eq 10.51.050|<tuple|10.63|?>>
    <associate|eq 10.52.050|<tuple|10.64|?>>
    <associate|eq 10.53.050|<tuple|10.65|?>>
    <associate|eq 10.54.050|<tuple|10.66|?>>
    <associate|eq 10.55.050|<tuple|10.67|?>>
    <associate|eq 10.56.050|<tuple|10.68|?>>
    <associate|eq 10.57|<tuple|10.69|?>>
    <associate|eq 10.58.051|<tuple|10.70|?>>
    ...
    <associate|sorting of a finite set|<tuple|10.97|?>>
  </collection>
</references>
